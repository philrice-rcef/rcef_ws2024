...
public function generateLiveMunicipalReportDataPy(Request $request){
        ...
        try {
            ...
            foreach($return_output as $data)
            {
                ...
                $ebinhi_tag = 0;
                $distributed_text = "<strong> Total: ".number_format($data['distributed']+$data['bags_claimed'])." bag(s)"."</strong>";
                $beneficiaries_text = "<strong> Total: ".number_format($data['beneficiaries'])."</strong>";
...
/*                 if($data['distributed'] > 0 ){
                    ...
                    if($data['bags_claimed'] > 0){
                         
                        
                    }
    
                    if($data['ebinhi_distri'] > 0 ){
                ...
                $male_text = "<strong> Total: ".number_format($data['total_male'])."</strong>"; //subject to change to male count
                $male_text .= "<br> Regular: ".number_format($data['total_male']);
                $male_text .="<br> Regular: ".number_format($data['bep_male_count']);
/*                 if($data['total_male'] > 0){
                    
                    if($data['total_male'] > 0){
                        
                    }
                    if($data['bep_male_count'] > 0){
               ...
               $female_text = "<strong> Total: ".number_format($data['total_female'])."</strong>";//subject to change to female count

               $female_text .="<br> Regular: ".number_format($data['total_female']);


               $female_text .="<br> Regular: ".number_format($data['bep_female_count']);


                
/*                 if($data['total_female'] > 0){
                    if($data['total_female'] > 0){
                    }
                    if($data['bep_female_count'] > 0){
                    }
                }else{
                    $female_text = "-";
                } */
               ...
               $area_text = "<strong> Total: ".number_format($data['total_final_area'])."</strong>";

               $area_text .="<br> Regular: ".number_format($data['total_final_area']);


               $area_text .="<br> Regular: ".number_format($data['actual_area_bep']);

/*                 if($data['total_final_area'] > 0){
                    if($data['total_final_area'] > 0){
                    }
                    if($data['actual_area_bep'] > 0){
                    }
                }else{
                    $area_text = "-";
                } */
