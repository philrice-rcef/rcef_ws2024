...
class DeliveryDashboardController extends Controller
{
    ...
    public function get_coops($id) {
        $coop = \DB::connection('seed_coop_db')
                ...
                ->select('tbl_cooperatives.coopName', 'tbl_cooperatives.regionId', 'tbl_total_commitment.total_value', 'tbl_cooperatives.accreditation_no', 'tbl_cooperatives.coopId', 'tbl_cooperatives.accreditation_no')
