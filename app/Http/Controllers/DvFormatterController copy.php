...
class DvFormatterController extends Controller
{
    ...
    public function index(){
        ...
        //             ->join('rcep_seed_cooperatives.tbl_cooperatives as b', 'b.current_moa', '=','a.moa_number')
        //             ->where('a.has_rla', '=', '1')
        ...
        public function update_status_overall(Request $request){
          ...
          public function particularsPreview(Request $request){
            ...
            $retention= $cost * 0.01; 
            $particulars = "Payment for ".number_format($tbl_delivery_data->total_bags)." bags of certified seeds for 2022 WS as per seed delivery dtd ".$deliveryDate." amounting to ".number_format($cost,2,".",",")." | Attached IAR: ".$iar_number;
