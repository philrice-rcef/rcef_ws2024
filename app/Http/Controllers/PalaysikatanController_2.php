...
class PalaysikatanController extends Controller
{
    ...
    return $data->target;
     ...
     public function station_status_list(Request $request){
          ...
          //->select('users.username','station_entries.station',DB::raw("count(farmer_info.farmer_id) as encoded"),'station_entries.user_encoded //as encoder',DB::raw("sum(crop_production.techno_area) as techno_area"))
