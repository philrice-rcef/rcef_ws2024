                    ...
                    <table style="width:100%; margin-right: 10px; margin-top: 12px;">
                        <tr>
                            ...
                            <td valign="top" style="height:80px;">
                                ...
                                <big> 
                               <b> {{strtoupper($data->firstName)}} {{strtoupper(substr($data->midName,0,1))}}. {{strtoupper($data->lastName)}}</b> <br>
                                RSBSA: {{$data->rsbsa_control_no}} </big> <br><br>
                                
                                <font size="8px;"> <b>BIRTHDATE(MM/DD/YYYY):</b> </font><br>
                                <b> {{date("m/d/Y", strtotime($data->birthdate))}} </b>   <br>
                                
                                @php
                                $address = strtoupper($data->brgy_name).strtoupper($data->municipality).",".strtoupper($data->province);
                        ...
                        <font size="{{$font_size}}"
                                <b>{{strtoupper($data->brgy_name)}} {{strtoupper($data->municipality)}}, {{strtoupper($data->province)}}  </b>
                        </font>
                        ...
                        <tr valign="top">
                               <td style="padding:0; margin:0; "> 
                                    <table style="width:100%; margin:0;padding:0;">
                                        <tr>
                                            <td valign="top" align="left" style="margin-bottom:0;">
                                        ...
                                        <tr>
                                            <td style="width:180px; margin:0;padding:0;" valign="top" align="left">
                                                @if($data->fca_name == null)
                                                <b> -NONE- </b>
                                                @else
                                                <font size="9px;">  <b> {{$data->fca_name}} </b> </font>
                            ...
                            <tr>
                                <td  valign="top"  align="left" style="padding:0;margin-left:0px; width:230px;"> 
                                    <ul style="margin:0;  padding-lef:15px; padding-top:5px; padding-bottom:0;">
                                        ...
                                        <li>In case of loss, please datarm your City/ Municipal Aggriculture Office.</li>
                                ...
                                <td rowspan="2" valign="top" style="margin-left:10px; text-align:center;">
                                    ...
                                    <div style="border-style:solid; background-color: #fff; margin-left:7px;margin-top:5px; height:auto;width:100px;"> 
                                        ...
                                        <img class="qr_class" src="data:image/jpg;base64, {{ base64_encode(QrCode::format('png')->size(240)->margin(0)->generate($data->rcef_id)) }}" style="height:90px;width:90px;margin-right:0px;margin-top:5px;margin-bottom:5px;"/> <br>
                                        <b>
                                        @php 
                                           echo substr($data->rcef_id,4,6);
                                        @endphp
                                        <b>
                                    </div>
