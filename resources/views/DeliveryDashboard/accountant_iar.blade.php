...
@section('content')
    ...
    <span style="font-size: 20px;font-weight: 700;font-style: italic;"><u>Filled-Up IAR for Accountant</u></span>
                ...
                <div class="x_panel">
                    ...
                    <div>
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <button type="button" name="button" id="acc_submit_iar_location" class="btn btn-lg btn-primary" style="float: right;"><i class="fa fa-sign-in"></i> Continue</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    @include('DeliveryDashboard.includes.accountant_iarlist')
@endsection
@push('scripts')
<script>
    ...
    $('#acc_submit_iar_location').on('click', function() {
