                    ...
                    <!-- Modal content-->
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-success" id="computeTotalCommitment">Save Delivery Commitment</button>
                            </div>
                        </div>
                    ...
                    <!-- Modal content-->
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row" style="display:none" id="add_more_totalCommit_fld">
                                    <div class="col-md-10">
                                        <input type="number" name="add_more_totalCommit" id="add_more_totalCommit" class="form-control" placeholder="Please enter the total commitment for this variety">
                                    </div>
                                </div>
                            </div>
                        </div>
...
@push('scripts')
    ...
    <script>
        ...
        $("#add_submit_btn").on("click", function(e){
            ...
            var total_commit = $("#add_more_totalCommit").val();

            if(seed_variety == "0"){
                alert("Please select a seed variety.");
            }else{
                if(seed_value == "0" && total_commit == "" ||
                   seed_value == "" && total_commit == ""){
                    $("#add_more_totalCommit_fld").css("display", "block");
                    $("#add_more_totalCommit").css("border", "1px solid red");
                }else{
                    $.ajax({
                        type: 'POST',
