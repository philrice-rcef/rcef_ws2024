                    ...
                    <div>
                        <div class="form-horizontal form-label-left">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" name="distribution_province_ws" id="distribution_province_ws">
                                        <option></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" name="distribution_municipality_ws" id="distribution_municipality_ws">
                                        <option></option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" name="dropoff_point_ws" id="dropoff_point_ws">
                                        <option></option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <button type="button" name="button" id="submit_distribution_location_ws" class="btn btn-lg btn-primary" style="float: right;"><i class="fa fa-sign-in"></i> Continue</button>
                                </div>
                            </div>
                        </div>
                    </div>
