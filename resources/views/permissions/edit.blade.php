...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="pull-left">
                <h2 class="mb-4" style="font-family: Fjalla_One; font-size: 3vw;">Edit Permission</h2>
            </div>
        </div>
    </div>

    {!! Form::model($permission, ['method' => 'POST', 'route' => ['permissions.update', $permission->permissionId]]) !!}
    {{ method_field('PATCH') }}
