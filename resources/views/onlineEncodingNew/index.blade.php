        ...
        <div class="wrapper">
            <header>
                <div class="title" style="line-height: 80%; padding: 2em 1em;">
                    ...
                    <br>
                    <span style="font-size: 1em; padding-left: 1em;" class="fw-700">for <span
                            style="color: green">new</span> farmers & no rice commodities.</span>
                </div>
            </header>
            <div class="heads">
                    ...
                    <form>
                        ...
                        <div class="heads">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="rsbsa-ctrl-no"
                                    aria-describedby="rsbsa-ctrl-no" placeholder="XX-XX-XX-XXX-XXXXXX">
                            </div>
                            <div class="form-group">
                                <label for="rcef-id">RCEF ID</label>
                                <input readonly type="text" class="form-control" id="rcef-id" aria-describedby="rcef-id"
                                    value="" placeholder="(Automatically generated)">
                                <small class="form-text text-muted">Auto-generated. No need to touch.</small>
                            </div>
                            <div class="form-group">
                                <label for="db-ref">Database Reference Number</label>
                                <input readonly type="text" class="form-control" id="db-ref" aria-describedby="db-ref"
                                    value="" placeholder="(Automatically generated)">
                                <small class="form-text text-muted">Auto-generated. No need to touch.</small>
                            </div>
                        </div>
                        <h3 class="fw-700">I. Personal Information</h3>
                        <small class="form-text text-warning"><i>Make sure you populate all parts of the name, sex and
                                birthdate for more thorough verification.</i></small>
                        <div class="heads">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="midName" aria-describedby="midName"
                                    placeholder="Dulce">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="extName" aria-describedby="extName"
                                    placeholder="Jr/Sr/I/II">
                            </div>
                            <div class="form-group">
                                <label for="sex">*Sex</label>
                                <select style="min-width: 150px; max-width: 100%;" name="sex" id="sex"
                        ...
                        <div class="heads">
                            <button id="btn-verify" class="btn btn-primary">Verify <i class="fa fa-check-circle-o"
                                    aria-hidden="true"></i></button>
                        </div>
                        <div class="if-verified slide-in">
                            ...
                            <div class="heads">
                                <div class="form-group">
                                    <label for="address_prv">*Province</label>
                                    <select style="min-width: 150px; max-width: 100%;" name="address_prv"
                                        id="address_prv" class="form-control form-select"></select>
                                </div>
                                <div class="form-group">
                                    <label for="farm_mun">*Municipality</label>
                                    <select style="min-width: 150px; max-width: 100%;" name="farm_mun" id="farm_mun"
                                        class="form-control form-select"></select>
                                </div>
                                <div class="form-group">
                                    <label for="farm_bgy">*Barangay</label>
                                    <select style="min-width: 150px; max-width: 100%;" name="farm_bgy" id="farm_bgy"
                                        class="form-control form-select"></select>
                                </div>
                                <div class="form-group">
                                    <label for="farm_area">*Farm Area (in ha)</label>
                                    <input type="number" class="form-control" id="farm_area"
                                        aria-describedby="farm_area" placeholder="X.XX ha">
                                </div>
                            </div>
                            ...
                            <div class="heads">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="mother_name"
                                        aria-describedby="mother_name" placeholder="Leave blank if unknown">
                                </div>
                            </div>
                            <h2 class="fw-700" style="margin-left: 1rem;">IV-B. Check if any of the following applies to
                                the farmer at hand.</h2>
                            <div class="flex-wrap" style="margin-left: 1.4rem;">
                                ...
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="is_dq">
                                    <label class="form-check-label" for="is_dq">Disqualified from RCEF</label>
                                </div>
                                <br>
                            </div>
                            <div class="form-check">
                                <textarea style="display: none" name="dq_reason" id="dq_reason" cols="60" rows="3"
                                    placeholder="Disqualification reason"></textarea>
                            </div>
                            <br>
                            <div class="heads">
                                <button id="btn-finalize-profile" class="btn btn-success">Finalize Profile <i
                                        class="fa fa-check-circle-o" aria-hidden="true"></i></button>
                            </div>
                            <div class="is-second-form-passed slide-in">
                                ...
                                <div class="heads">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <select style="min-width: 150px; max-width: 100%;" name="dropoff_select"
                                            id="dropoff_select" class="form-control form-select"></select>
                                ...
                                <div class="heads">
                                    <div class="form-check">
                                        ...
                                        <select style="min-width: 150px; max-width: 100%;" name="seed_variety"
                                            id="seed_variety" class="form-control form-select"></select>
                                    </div>
                                    <div class="form-group">
                                        <label for="claimed_area">Area Claimed</label>
                                        <input type="number" class="form-control" id="claimed_area"
                                            aria-describedby="claimed_area" placeholder="0.46" readonly>
                                        <small class="form-text text-muted">Based on farm area</small>
                                    </div>
                                    <div class="form-group">
                                        <label for="claimed_bags">Bags Claimed</label>
                                        <input type="number" class="form-control" id="claimed_bags"
                                            aria-describedby="claimed_bags" placeholder="1" readonly>
                                ...
                                <div class="heads-small">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="area_harvested"
                                            aria-describedby="area_harvested" placeholder="X.X ha">
                                    </div>
                                    <div class="form-group">
                                        <label for="no_of_bags">*No. Of Bags</label>
                                        <input type="number" class="form-control" id="no_of_bags"
                                            aria-describedby="no_of_bags" placeholder="XX bags">
                                    </div>
                                    <div class="form-group">
                                        <label for="wt_per_bag">*Weight per bag</label>
                                        <input type="number" class="form-control" id="wt_per_bag"
                                            aria-describedby="wt_per_bag" placeholder="XX kgs">
                                    </div>
                                    <div class="form-group">
                                        <label for="yield">Yield</label>
                                        <input type="number" class="form-control" id="yield" aria-describedby="yield"
                                            placeholder="T/ha" readonly>
                                        <small class="form-text text-muted">Automatically computed</small>
                                    </div>
                                </div>
                                <div class="heads">
                                    <div class="form-group">
                                        ...
                                        <select style="min-width: 150px; max-width: 100%;" name="variety_planted"
                                            id="variety_planted" class="form-control form-select">
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="seed_type">*Seed Type</label>
                                        <select style="min-width: 150px; max-width: 100%;" name="seed_type"
                                            id="seed_type" class="form-control form-select">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select style="min-width: 150px; max-width: 100%;" name="seed_class"
                                            id="seed_class" class="form-control form-select">
                                ...
                                <div class="heads">
                                    <div class="form-group">
                                        ...
                                        <select style="min-width: 150px; max-width: 100%;" name="crop_estab"
                                            id="crop_estab" class="form-control form-select">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select style="min-width: 150px; max-width: 100%;" name="ecosystem_cs"
                                            id="ecosystem_cs" class="form-control form-select">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select style="min-width: 150px; max-width: 100%;" name="planting_month"
                                            id="planting_month" class="form-control form-select">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select style="min-width: 150px; max-width: 100%;" name="planting_week"
                                            id="planting_week" class="form-control form-select">
...
@push('scripts')
    <script>
        ...
        globalInfo = {
            ...
            "prev_claimable": 0,
            "prev_final_area": 0.00000,
            "prev_claimed": 0,
            "prev_claimed_area": 0.00000,
            "dq_reason": "",
            "is_ebinhi": 0,
            "print_count": 0,
            "to_prv_code": ""
        ...
        $("#is_dq").on('change', () => {
            if ($("#is_dq").prop("checked")) {
                $("#dq_reason").css("display", 'block');
            } else {
                $("#dq_reason").css("display", 'none');
                globalInfo.is_dq = "";
            }
        });
        ...
        $("#btn-finalize-profile").on("click", (event) => {
            ...
            globalInfo.is_dq = $("#is_dq").prop("checked") ? 1 : 0;
            globalInfo.dq_reason = $("#is_dq").prop("checked") ? $("#dq_reason").val() : "";
        ...
        function getSeedVars() {
            $.ajax({
                type: 'GET',
                url: "{{route('onlineEncodingNew.getSeedVars')}}",
                success: function (result) {
                    $("#variety_planted").append(
                        `<option value="">-</option>`
                    );
                    result.forEach((element, idx) => {
                        $("#variety_planted").append(
                            `<option value="${element.seedItem}">${element.seedName}</option>`
                        );
                    });
                }
            });
