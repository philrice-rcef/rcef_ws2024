...
<body>
     ...
     $w_data_col = 21;
     $wo_data_col = 24;
    $version_with_data = "5.1";
    $version_no_data = "5.1B";
            ...
            <thead>
                <tr>
                    ...
                    @endif
                        ...
                        <div style="margin-top:40px; width: 21%; margin-left: 260px; margin-bottom:30px;">
                            <left><span style="font-size: 20px;"> <center>(Binhi e-Padala)  Farmer Acknowledgement Receipt  <br>(Seeds) RCEF Seed Program </center> </span></left>
			  ...
			  @for ($x = $cnt; $x < $totalFarmer; $x++)
				...
				<tr>
                    ...
                    <b>  @if(isset($tag_val))
                        {{strtoupper($list[$cnt]["lastname"])}}, {{strtoupper($list[$cnt]["firstname"])}} {{strtoupper($list[$cnt]["middname"])}}
                        @else
                        {{strtoupper($list[$cnt]["lastname"])}}, {{strtoupper($list[$cnt]["firstname"])}} {{strtoupper($list[$cnt]["middname"])}}
                        @endif </b>
                    </td>
...
{{--                     
                    ...
                    <td></td>
                    <!--SBSA Registered Area-->
                        <td style="width: 40px;" align="center"> {{$list[$cnt]["area"]}}</td>
                    <!--MAX BAG-->
