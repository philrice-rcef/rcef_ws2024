            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="x_content form-horizontal form-label-left">
                    <br/>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-3"># of ID (Maximum of 200):</label>
                            <div class="col-md-9 col-sm-9 col-xs-9">
                                <input type="number" class="form-control" name="QRLimit" id="QRLimit" value="200"> 
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="download_fld" syle="display:none;">
                            <div class="col-md-12 col-sm-12 col-xs-12" id="download_wrapper" style="max-height: 150px;overflow: auto;height: 150px;">
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $.each(data, function(index, value){
                        $("#download_wrapper").append("<a style='margin-top:10px;' href='https://rcef-seed.philrice.gov.ph/rcef_ws2020/public/file/"+value+"' class='btn btn-warning' download><i class='fa fa-arrow-circle-o-down'></i> "+value+"</a>");
                    });
                }
            });
        });
