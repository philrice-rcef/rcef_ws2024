...
<body style=" padding: 15px;">
    ...
    <table style="width:100%;border: 1px solid black;border-left:0;border-right:0;">
        <tr>
            <td style="width:14%;">
                <img src="{{ public_path('images/plogo.jpg')}}" style="height: 120px;width: 120px;margin-top: -50px;" alt=""><br><br>
            ...
            <td>
                <p style="    margin-bottom: 0;">
                    ...
                    <span style="font-size: 20px;font-weight: 600;vertical-align: middle;">Seed Variety: </span> 
                    <span class="variety"></span>  <span style="font-size: 20px;font-weight: 600;vertical-align: middle;">Bags Received:</span> <span class="bag">1</span><span class="bag">2</span><span class="bag">3</span><span class="bag">4</span>
                </p>
            </td>
        </tr>
    </table>
