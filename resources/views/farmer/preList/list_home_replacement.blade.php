                ...
                <tr>
                    ...
                    @endif
                        ...
                        <div style="margin-top:10px; width: 21%; margin-left: 260px;">
                            <left><span style="font-size: 20px;"> <center> Farmer Acknowledgement Receipt  <br>(Replacement Seeds) </center> </span></left>
...
{{--                     
                    ...
                    <td></td>
                    <!--SBSA Registered Area-->
                        <td style="width: 40px;" align="center"> {{$list[$cnt]["crop_area"]}}</td>
                    <!--MAX BAG-->
