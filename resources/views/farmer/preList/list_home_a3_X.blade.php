		...
		<table style="width:100%; margin-right: 10px; margin-top: 15px;">
            <thead>
                <tr>
                    ...
                    @endif
                        ...
                        <div style="margin-top:30px; width: 50%; margin-left: 260px;">
                            ...
                            <left><span style="font-size: 20px;">RCEF Seed Program</span></left><br> <br> <br>
                        </div>
                        ...
                        @if($wData == 1)
                        <div style="position: fixed; text-align: right; margin-right: 10px;  top:0px;right:0px;"> FAR V3.1</div>
                        @else
                        <div style="position: fixed; text-align: right; margin-right: 10px;  top:0px;right:0px;"> FAR V3.2</div>
                        @endif


                        <div style="margin-top: 30px;margin-left: 10px;">
                            <span>Year/Season: __<u>Dry Season 2022</u>___</span><br>
				...
				<tr>
                    ...
                    <th style="font-size: 10px; width: 180px;"><center>Name of Authorized Representative </center></th>
			  ...
			  @for ($x = $cnt; $x < $totalFarmer; $x++)
				...
				<tr>
					<td style="width: 10px; height: 30px;">{{$itm}} </td>
					<td colspan="3" style="width:260px; height: 17px; font-size: 13px;"><b> {{strtoupper($list[$cnt]["lastName"])}}, {{strtoupper($list[$cnt]["firstName"])}} {{strtoupper($list[$cnt]["midName"])}} </b></td>
            ...
            <tr>
                    ...
                    <div style="position: fixed; text-align: right; margin-right: 8px;  bottom:120px;right:5px;">
                        ...
                        <div style="position: fixed; text-align: right; margin-right: 10px;  bottom:15px;right:0px;">
                              @if($wData == 1)
                               PhilRice RCEF FAR V3.1 Rev 00 Effectivity Date: 08 September 2021
                            @else
                               PhilRice RCEF FAR V3.2 Rev 00 Effectivity Date: 08 September 2021
                            @endif
