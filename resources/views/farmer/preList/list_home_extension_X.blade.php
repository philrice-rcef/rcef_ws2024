...
<body>
            ...
            <thead>
                <tr>
                     ...
                     <div style="position: absolute; border: 1px dotted black; top:30px; width: 25%; height: 110px; right:20px;">
                        ...
                        <div style="position: fixed; text-align: right; margin-right: 10px;  top:0px;right:0px;"> FAR V3.4</div>
			  ...
			  @for ($x = $cnt; $x < $totalFarmer; $x++)
				...
				<tr>
					...
					<td style="width:120px; height: 17px; font-size: 10px;"><b> {{strtoupper($list[$cnt]["lastName"])}}, {{strtoupper($list[$cnt]["firstName"])}} {{strtoupper($list[$cnt]["midName"])}} </b></td>

                    <td style="width: 50px; font-size: 11px; text-align: center;">{{strtoupper($list[$cnt]["sex"] == "Female" ? "F" : "M")}}</td>
                    <?php 
                        if($list[$cnt]["birthdate"] !== "0000-00-00"){
                            $today = date("Y-m-d");
                            $bday = date("Y-m-d", strtotime($list[$cnt]["birthdate"]));
                            $age = date_diff(date_create($bday), date_create('now'))->y;
                            echo "<td style='width: 50px; text-align:center;'>".$age."</td>";
   ...
   <tr>
                    ...
                    <div style="position: fixed; text-align: right; margin-right: 8px;  bottom:110px;right:10px;">
                      ...
                      <div style="position: fixed; text-align: right; margin-right: 10px;  bottom:15px;right:0px;">    PhilRice RCEF FAR V3.4 Rev 00 Effectivity Date: 08 September 2021 </div>
                </th>
            </tr>
