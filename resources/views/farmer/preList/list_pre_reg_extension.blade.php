...
<body>
		...
		<table style="width:100%; margin-right: 50px; margin-top: 15px;">
            <thead>
			  ...
			  @for ($x = $cnt; $x < $totalFarmer; $x++)
				...
				<tr>
					<td style="width: 10px;">{{$itm}} </td>
                    <td style="width:120px; height: 17px; font-size: 10px;"><b> {{strtoupper($list[$cnt]["last_name"])}}, {{strtoupper($list[$cnt]["first_name"])}} {{strtoupper($list[$cnt]["mid_name"])}} {{$list[$cnt]["ext_name"]}} </b></td>
   ...
   <tr>
                    ...
                    <div style="position: fixed; text-align: right; margin-right: 8px;  bottom:100px;right:30px;">
                      ...
                      <div style="position: fixed; text-align: right; margin-right: 10px;  bottom:15px;right:0px;">    PhilRice RCEF FAR V{{$version}} Rev 01 Effectivity Date: 15 March 2022 </div>
                </th>
            </tr>
