...
<body>
		...
		<table style="width:100%; margin-right: 50px; margin-top: 15px;">
            <thead>
                <tr>
                        ...
                        <div style="position: fixed; text-align: right; margin-right: 10px;  top:0px;right:0px;"> FAR V4.3</div>
                        

                        <div style="margin-top: 30px;margin-left: 10px;">
                            <span>Year/Season: __<u>Wet Season 2022</u>___</span><br>
                            <span>Drop-off Point (City/Municipality, Province) _____________________</span><br>
                            <span>RSBSA Code: Region________, Province:________, Municipality:_________
							_, Barangay:________
   ...
   <tr>
                    ...
                    <div style="position: fixed; text-align: right; margin-right: 8px;  bottom:100px;right:30px;">
                      ...
                      <div style="position: fixed; text-align: right; margin-right: 10px;  bottom:15px;right:0px;">    PhilRice RCEF FAR V4.3 Rev 01 Effectivity Date: 15 March 2022  </div>
                </th>
            </tr>
