		...
		<table style="width:100%; margin-right: 10px; margin-top: 12px; border-style:ridge">
            <thead>
                <tr>
                    ...
                    @endif
                        ...
                        <div style="margin-top:10px; width: 21%; margin-left: 260px;">
                            <left><span style="font-size: 20px;"> <br>Farmer  Acknowledgement <br> Receipt (Seeds) </span></left>
                        ...
                        <div style="position: absolute; border: 1px dotted black; top:5px; width: 60%; height: auto; right:0px;">
                            ...
                            <table style="border: 0; margin-left: 10px; margin-top: 0px;" width="100%">
                                ...
                                <tr> 
                                    <td  style="border-style: none;"> *<u> Gross harvest</u> - Total number of bags from the thresher/harvester during the previous season <br>(including shares of harvesters, machine/s, owner [if land is leased/rented])</td>
                                ...
                                <tr> 
                                    <td width="70%"  style="border-style: none;"> * <u>Area harvested (ha) </u>- Total area harvested during the previous season <br>  * <u>No. of bags</u> - Number of bags received per variety</td>
                                ...
                                <tr> 
                                    <td width="70%" style="border-style: none;" > * <u>Area to be planted (ha) </u>- Intended area for planting for wet season 2023 <br> * <u>Variety Received </u>- Name of variety received</td>
                                  
                                </tr>

                                <tr> 
                                    <td width="70%"  style="border-style: none;" > * <u>Registered Area (ha) </u>- Maximum/Total Physical Rice Area <br>  * <u>Crop Establishment </u> - [D-Direct Seeding | T-Transplanted]</td>
                                </tr>
                                <tr> 
                        ...
                        <div style="position: absolute; border: 1px dotted black; top:30px; width: 11%; height: 185px; right:10px;">
                        ...
                        <div style="margin-top: 100px;margin-left: 5px; margin-bottom:10px;">
				...
				<tr>
                    ...
                    <th  style="width: 60px;" rowspan="2" align="center">Registered <br> Area</th>
                    <th  align="center" style="width: 60px;" rowspan="2">Area to be planted</th>
                    ...
                    <th  style="width:40px; font-size: 10px;" align="center" rowspan="2">Crop Estab. <br> [D/T] </th>
                    <th style="width:55px;" rowspan="2"><center>Irrigation Source</center></th> 

                    <th  style="width:40px; font-size: 10px;" align="center" rowspan="2">Expected Sowing Date <br> [Month/Week] </th>


                    <th style="font-size: 10px;" style="width:30px;"><center> Data Sharing Consent</center></th>



               

                    <th style="font-size: 10px; width: 80px;"><center>Name of Authorized Representative </center></th>
                ...
                <tr>
                    ...
                    <th  style="width:50px; font-size: 10px;" align="center">Ave. wt. <br> per bag <br> (kg)</th>
