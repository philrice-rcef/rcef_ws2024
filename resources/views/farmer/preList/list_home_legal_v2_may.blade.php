...
<body>
     ...
     $w_data_col = 22;
     $wo_data_col = 25;
    $version_with_data = "6.2";
    $version_no_data = "6.2B";
    ...
    <table style="font-size: 20px;border-style: none;">
        ...
        <tbody>
            ...
            <tr> 
                ...
                <td style="border-style: none;">
                   Total number of Barangay merged on registered area
                </td>
            </tr>
            ...
            <tr>
                    ...
                    <div style="position: fixed; text-align: right; margin-right: 8px;  bottom:110px;right:5px;">
                        ...
                        <div style="position: fixed; text-align: right; margin-right: 10px;  bottom:15px;right:0px;">
                              @if($wData == 1)
                               PhilRice RCEF FAR V{{$version_with_data}} Rev 00 Effectivity Date: 31 May 2023
                            @else
                               PhilRice RCEF FAR V{{$version_no_data}} Rev 00 Effectivity Date: 31 May 2023
                            @endif
