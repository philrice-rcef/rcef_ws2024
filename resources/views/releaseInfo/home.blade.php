...
@push('scripts')
    ...
    <script> 
        ...
        $('#region').on('change', () => {
            ...
            $.ajax({ 
                type: 'POST',
                url: "{{ route('releaseInfoProvinces') }}",
                data: {
                    _token: "{{ csrf_token() }}",
                    reg: $reg
                },
        ...
        $('#provinces').change(() => {
            ...
            $.ajax({ 
                type: 'POST',
                url: "{{ route('releaseInfoMunicipalities') }}",
                data: {
                    _token: "{{ csrf_token() }}",
                    prov: $prov
                },
