            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb" style="margin-top: 15px;">
                    <ol class="breadcrumb" style="background-color: #d5d5d5;">
                        <li class="breadcrumb-item"><a href="{{url('request/user')}}">Users</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Request New User</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        {!! Form::open(array('route' => 'users.store.request','method'=>'POST')) !!}
                            ...
                            <button type="submit" class="btn btn-success" style="float: right; margin-top: 10px;">Request User</button>
                    	{!! Form::close() !!}
                    </div>
                </div>
            </div>
