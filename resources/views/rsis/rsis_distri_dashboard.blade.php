            ...
            <div class="col-md-4">
                    ...
                    <div class="card bg-c-blue order-card" >
                        <div class="card-block" >
                            ...
                            <h1 class=""><i class="fa fa-user"></i><span>      {{$total_growers}} Seed Grower</span></h1>
                            
                         <h5 style="position: absolute; bottom:0;"> Total Cooperatives:     {{$sg_list}} SGC/A's  </h5> 
            ...
            <div class="col-md-4">
                ...
                <div class="card bg-c-green order-card">
                    <div class="card-block">
                        ...
                        <h2 class="">  <i class="fa fa-calendar-check-o" aria-hidden="true"></i> Start:   {{$earliest}} </span></h2>
                        <h2 class=""> <i class="fa fa-history" aria-hidden="true"></i> End:  {{$lastest}} </span></h2>
                        
                        
                    <h5 style="position: absolute; bottom:0;"> Total Area:  {{number_format($total_area,2)}} (ha)  </h5>
  ...
  $('#show_rla_modal').on('show.bs.modal', function (e) {
    ...
    function export_excel(account){
            ...
            if(yesno){
                ...
                window.open(url+"/rsis/coop/export_production/"+account,"_blank");
