            ...
            <div class="col-md-4">
                    ...
                    <div class="card bg-c-green order-card">
                        <div class="card-block">
                            ...
                            <h1 class=""><i class="fa fa-users"></i><span>      {{$sg_list}} SGC/A's</span></h1>
                            <p class="m-b-20"> <h5> Total Cooperatives:     {{$total_coops}} SGC/A's  </h5> </p>
                    ...
                    @foreach ($regions as $region)
                        <div class="card">
                            <div class="card-header" id="headingOne" >
                                ...
                                <h5 class="mb-0" style="margin:0;"  data-toggle="collapse" data-target="#collapse{{$region->id}}" aria-controls="{{$region->id}}" onclick="getCoopsDetails({{$region->id}}, 'list_{{$region->id}}')" >
                                    @if($region->with_data == "true")
