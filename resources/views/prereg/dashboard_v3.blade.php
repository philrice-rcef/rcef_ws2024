                                ...
                                <div class="_grid_item shadow-md _card mp">
                                    ...
                                    <div class="___grid">
                                        <div class="___grid_item _card shadow">
                                            <center><h1 class="bold omega_font">{{number_format($total_fca_prereg)}}</h1></center>
                                            <center><h4 class="bold">FCA Member(s)</h4></center>
                                        </div>
                        ...
                        <div class="grid_bottom">
                            ...
                            <div class="grid_bottom_item _card shadow-md mp">
                                ...
                                <div class="cee_content" style="display: grid; grid-template-columns: 1fr 2fr;">
                                    ...
                                    <!-- @foreach ($count_fca as $fca)
                                        <span class="bold">{{$fca->province_name.", "}}{{$fca->municipality_name}}</span> <span>{{$fca->count}}</span>
                                    @endforeach -->
                                </div>
                            </div>
                        </div>
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $.each(data.muni, function(){
                        $("#prv-select").append('<option value="'+data.muni+'">'+data.muni+'</option>');
                    });
                }
            });
        });
