                            ...
                            <div class="col-md-12" id="farmer_profile_tab">
                                <div class="col-md-12" style="display: flex!important; justify-content: center; align-items: center;">
                                        ...
                                        <div class="card" style="padding: 2rem 1rem">
                                            ...
                                            <div class="col-md-12">
                                                <div class="col-md-12" id="btn_for_parcelary">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="remaining_val" id="remaining_val">
                                                <input type="text" name="db_ref" id="db_ref">
                                                <input type="text" name="final_area" id="final_area">
                                                <input type="text" name="sex" id="sex">
                                                <input type="text" name="parcelled_id" id="parcelled_id">
...
<script>
    ...
    $("#add_variety_dist").on("click", function(){
        ...
        if(remaining_val < bags){
            dialog_prompt("Claimable Exceed");
            return ;
        }

       

        remaining_val = remaining_val - bags;
        $("#remaining_val").val(remaining_val);
...
$(document).on('hide.bs.modal','#intervention_scanner_modal', function () {
    ...
    $("#save_update").on("click", function(){
        ...
        if(tbl_data <= 0){
            dialog_prompt("No Claim Details");
            return ;
        }
        ...
        var db_ref = $("#db_ref").val();
        var parcelled_id = $("#parcelled_id").val();
        ...
        $.ajax({
            ...
            success: function(result){
                if(result["msg"] != ""){
                    ...
                    $("#btn_for_parcelary").empty().append(result["view_parcel"]);

                    $("#rcef_id").val(result["rcef_id"]);
                    
                    $("#db_ref").val(result["db_ref"]);
                    ...
                    $("#final_area").val(result["final_area"]);
                    $("#sex").val(result["sex"]);

                    $("#parcelled_id").val(result["parcelled_id"]);
                    ...
                    $("#remaining_val").val(result["remaining"]);
