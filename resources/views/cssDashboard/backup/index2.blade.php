      ...
      <strong>Binhi e-Padala Seeds Distribution Survey Results</strong>
        <div class="actual_content">
          <div class="headings" style="display: grid; grid-template-columns: 3fr 3fr 3fr 2fr; gap: 2rem;">
            ...
            <div class="_card1 slideFromRight" style="opacity: 0; display: flex; gap: 1.2em; background: rgba(143, 201, 255, 0.286); border-radius: 20px; padding: 0.4rem 1.2rem 0.4rem 0.4rem;">
