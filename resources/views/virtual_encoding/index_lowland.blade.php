...
@push('scripts')
    ...
    $("#new_farmer").on("click", function(){
        ...
        $('#select_members_modal').on('show.bs.modal', function (e) {
            ...
            mother_lname =  $(e.relatedTarget).data('mother_lname');
            mother_fname =  $(e.relatedTarget).data('mother_fname');
            mother_mname =  $(e.relatedTarget).data('mother_mname');
            mother_suffix =  $(e.relatedTarget).data('mother_suffix');
        ...
        $('#confirmMembers').on('click', function(e){
            ...
            var combinedParcel = "<div class='col-md-4'> <a class='btn btn-dark btn-lg parcel_btn' data-toggle='modal' data-backdrop='static' data-keyboard='false' data-target='#select_dop_modal'data-db_ref='"+db_ref+"' data-mother_lname = '"+mother_lname+"' data-mother_fname = '"+mother_fname+"' data-mother_mname = '"+mother_mname+"' data-mother_suffix = '"+mother_suffix+"' data-is_ip = '"+is_ip+"' data-tribe_name = '"+tribe_name+"' data-is_pwd   = '"+is_pwd+"' data-birthdate  = '"+birthdate+"' data-claiming_prv = '"+claiming_prv+"' data-tel_no = '"+tel_no+"' data-served = 'true' data-remaining='"+remaining+"' data-final_area = '"+totalArea+"' data-remaining_area = '"+remaining_area+"' data-prv='"+province+"' data-municipality='"+municipality+"' data-province='"+province+"' style='width:100%;'>"+province+"<br> "+municipality+"<br>"+totalArea+" available out of "+totalArea+" (ha) </a> </div>";
        ...
        function get_parcel_list(db_ref, prv){
            ...
            success: function(result){
                ...
                $.each(result["parcel_list"], function (i, d) {
                    ...
                    if(d.remaining > 0 ){
                        var parcel = "<div class='col-md-4'> <a id='parcel_"+d.id+"' data-toggle='modal' data-backdrop='static' data-keyboard='false' data-target='#select_members_modal' data-db_ref='"+d.id+"' data-mother_lname = '"+d.mother_lname+"' data-mother_fname = '"+d.mother_fname+"' data-mother_mname = '"+d.mother_mname+"' data-mother_suffix = '"+d.mother_suffix+"' data-is_ip = '"+d.is_ip+"' data-tribe_name = '"+d.tribe_name+"' data-is_pwd   = '"+d.is_pwd+"' data-birthdate  = '"+d.birthdate+"' data-claiming_prv = '"+d.claiming_prv+"' data-tel_no = '"+d.tel_no+"' data-served = 'true' data-remaining='"+d.remaining+"' data-final_area = '"+d.final_area+"' data-remaining_area = '"+d.remaining_area+"' data-prv='"+d.prv+"' data-municipality='"+d.municipality+"' data-province='"+d.province+"' class='btn btn-dark btn-lg parcel_btn' style='width:100%;'  value='"+d.prv+";"+d.id+"'  >"+d.province+"<br> "+d.municipality+"<br>"+d.remaining_area+" available out of "+d.final_area+" (ha) </a> </div>";
                    }else{
