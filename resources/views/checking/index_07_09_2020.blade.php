...
<script>
    ...
    function save_old(old_rsbsa,new_rsbsa){
    ...
    function save_edit(old_rsbsa,new_rsbsa,middle_name, data_category){
        $("#edit_btn").attr("disabled","");
        $("#edit_btn").empty().html("Updating data please wait...");
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data["return_msg"] == "new_data_rsbsa_exists"){
                    ...
                    save_edit(old_rsbsa,new_rsbsa,middle_name, "new_or_same_rsbsa")
                
                }else if(data["return_msg"] == "no_pending_data_old_data"){
                    if (confirm("Is this: "+data["farmer_name"]+"?")) {
                        save_old(old_rsbsa,new_rsbsa);
