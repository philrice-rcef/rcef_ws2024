...
<script>
    ...
    function save_old(old_rsbsa,new_rsbsa, middle_name, first_name, last_name, ext_name, birth_date, sex){
    ...
    function save_edit(old_rsbsa,new_rsbsa,middle_name, data_category, first_name, last_name, ext_name, birth_date, sex){
        $("#edit_btn").attr("disabled","");
        $("#edit_btn").empty().html("Updating data please wait...");
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data["return_msg"] == "new_data_rsbsa_exists"){
                    ...
                    save_edit(old_rsbsa,new_rsbsa,middle_name, "new_or_same_rsbsa", first_name, last_name, ext_name, birth_date, sex)
                
                }else if(data["return_msg"] == "no_pending_data_old_data"){
                    if (confirm("Is this: "+data["farmer_name"]+"?")) {
                        save_old(old_rsbsa,new_rsbsa, middle_name, first_name, last_name, ext_name, birth_date, sex);
