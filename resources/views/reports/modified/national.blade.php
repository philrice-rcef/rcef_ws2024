    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
		...
		<div class="row">
			<div class="col-md-6">
					...
					<div class="x_content form-horizontal form-label-left">
						<div class="row tile_count" style="margin: 0">
							<div class="col-md-12 col-sm-12 col-xs-12 tile_stats_count" style="padding-bottom: 0;padding-left: 0;">
								<div class="count"><i class="fa fa-map-marker"></i> {{$national_data['municipalities']}}</div>
							</div>
						</div>
					</div>
				</div><br>
					...
					<div class="x_content form-horizontal form-label-left">
						<div class="row tile_count" style="margin: 0">
							<div class="col-md-7 col-sm-12 col-xs-12 tile_stats_count" style="padding-bottom: 0;padding-left: 0;">
								<div class="count"><i class="fa fa-users"></i> {{$national_data['total_farmer'] == '' ? 0 : number_format($national_data['total_farmer']+$paymaya_beneficiaries)}}</div>
							</div>
                                ...
                                <div class="row ml-3">
                                    <div class="col-md-12 col-sm-6 col-xs-6">
                                        <div class="sub-count" id="">
                                         <i class="fa fa-cubes">    Conventional (Regular): {{number_format($national_data['total_farmer'])}} </i> </div>
                                    </div>
				...
				<div class="x_panel">
					<div class="x_title">
						<h2>Actual Area (ha)</h2>
						<div class="clearfix"></div>
					</div>
					<div class="x_content form-horizontal form-label-left">
						<div class="row tile_count" style="margin: 0">
							<div class="col-md-12 col-sm-12 col-xs-12 tile_stats_count" style="padding-bottom: 0;padding-left: 0;">
								<div class="count"><i class="fa fa-map-marker"></i> {{$national_data['actual_area'] == '' ? 0 : number_format($national_data['actual_area'], '2', '.', ',')}}</div>
							</div>
						</div>
					</div>
				</div><br>
				...
				<div class="x_panel">
					<div class="x_title">
						<h2>Bags Distributed (20kg/bag)</h2>
						<div class="clearfix"></div>
					</div>
					<div class="x_content form-horizontal form-label-left">
						<div class="row tile_count" style="margin: 0">
							<div class="col-md-12 col-sm-12 col-xs-12 tile_stats_count" style="padding-bottom: 0;padding-left: 0;">
								<div class="count"><i class="fa fa-truck"></i> {{$national_data['total_bags'] == '' ? 0 : number_format($national_data['total_bags'])}}</div>
							</div>
						</div>
					</div>
				</div><br>
			...
			<div class="col-md-6">
				<div class="x_panel">
					...
					<div class="x_content form-horizontal form-label-left">
						<div class="row tile_count" style="margin: 0">
							<div class="col-md-7 col-sm-12 col-xs-12 tile_stats_count" style="padding-bottom: 0;padding-left: 0;">
								<div class="count"><i class="fa fa-male"></i> {{$national_data['total_male'] == '' ? 0 : number_format($national_data['total_male'])}}</div>
							</div>
							<div class="col-md-5 col-sm-12 col-xs-12" style="padding-bottom: 0;padding-left: 0;">
                                <div class="row ml-3">
                                    <div class="col-md-12 col-sm-6 col-xs-6">
                                        <div class="sub-count" id="">
                                           <i class="fa fa-cubes">  Conventional (Regular): {{number_format($national_data['total_male'])}} </i> </div>
                                    </div>
				...
				<div class="x_panel">
					...
					<div class="x_content form-horizontal form-label-left">
						<div class="row tile_count" style="margin: 0">
							<div class="col-md-7 col-sm-12 col-xs-12 tile_stats_count" style="padding-bottom: 0;padding-left: 0;">
								<div class="count"><i class="fa fa-female"></i> {{$national_data['total_female'] == '' ? 0 : number_format($national_data['total_female'])}}</div>
							</div>
							...
							<div class="col-md-5 col-sm-12 col-xs-12" style="padding-bottom: 0;padding-left: 0;">
                                <div class="row ml-3">
                                    <div class="col-md-12 col-sm-6 col-xs-6">
                                        <div class="sub-count" id="">
                                           <i class="fa fa-cubes">  Conventional (Regular): {{number_format($national_data['total_female'])}} </i> </div>
                                    </div>
            ...
            ?>				
                ...
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Yield Ton / Ha (42 RCEF PROVINCES) </h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content form-horizontal form-label-left">
                        <div class="row tile_count" style="margin: 0">
                            <div class="col-md-12 col-sm-12 col-xs-12 tile_stats_count" style="padding-bottom: 0;padding-left: 0;">
                                <div class="count"><i class="fa fa-bar-chart"></i> {{$national_data['yield'] == '' ? 0 : number_format($national_data['yield'], '2', '.', ',')}}</div>
                            </div>
                        </div>
                    </div>
                </div><br> 
				...
				<div class="x_panel">
					<div class="x_title">
						<h2>Yield Ton / Ha (All Provinces Served this Season)</h2>
						<div class="clearfix"></div>
					</div>
					<div class="x_content form-horizontal form-label-left">
						<div class="row tile_count" style="margin: 0">
							<div class="col-md-12 col-sm-12 col-xs-12 tile_stats_count" style="padding-bottom: 0;padding-left: 0;">
								<div class="count"><i class="fa fa-bar-chart"></i> {{$national_data['yield_all'] == '' ? 0 : number_format($national_data['yield_all'], '2', '.', ',')}}</div>
							</div>
						</div>
					</div>
				</div><br>
