...
@section('content')
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel collapse" id="collapseExample" style="min-height:58px;height: 22.2222px;" aria-expanded="false">
            <div class="x_title">
                <h2>
...
@push('scripts')
    ...
    <script>
        $('#collapseExample').on('shown.bs.collapse', function () {
            $("#toggle_btn").removeClass("fa-angle-double-right").addClass("fa-angle-double-down");
        });

        $('#collapseExample').on('hidden.bs.collapse', function () {
            $("#toggle_btn").removeClass("fa-angle-double-down").addClass("fa-angle-double-right");
        });
