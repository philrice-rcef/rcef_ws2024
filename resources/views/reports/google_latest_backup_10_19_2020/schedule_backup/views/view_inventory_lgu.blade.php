                ...
                <div class="x_content">
                    <div class="form-horizontal form-label-left">
                        <div class="form-group" id="from_bagsRemaining_div">
                            ...
                            <div class="col-md-10 col-sm-10 col-xs-10" >
                                <input type="number" class="form-control" id="from_bags_remaining" name="from_bags_remaining" min="1" max="9999" value="{{$schedule_bagsInLgu}}" readonly>
                            </div>
                        </div>
            ...
            if(seed_variety != "0" && seed_total != "0"){
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        var current_total = $("#from_bags_remaining").val();
