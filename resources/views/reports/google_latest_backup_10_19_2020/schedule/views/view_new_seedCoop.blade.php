...
@section('content')
    ...
    <div class="col-md-12 col-sm-12 col-xs-12" style="height: 1200px;">
        ...
        <form action="{{route('rcep.google_sheet.editNewDS2021')}}" method="POST" data-parsley-validate="" id="edit_form">
            {{ csrf_field() }}
            <div class="x_panel">
                <div class="x_title">
                    <h2>
                        ...
                        <div class="form-group" id="to_municipality_div">
                            ...
                            <div class="col-md-10 col-sm-10 col-xs-10" >
                                <select name="to_municipality" id="to_municipality" class="form-control" required data-parsley-min="1">
                                    <option value="{{$schedule_to_municipality}}">{{$schedule_to_municipality}}</option>
                                </select>
                            </div>
                        </div>
