...
@push('scripts')
    ...
    <script>
        ...
        $("#summary_btn").on("click", function(e){
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('rcef.report.beneficiaries.result2') }}",
                data: {
                    _token: "{{ csrf_token() }}",
                    province: province,
                    region: region
                ...
                success: function(data){
                    ...
                    if(data != 'rsbsa_error'){
                        ...
                        $("#province_name").html($("#region option:selected").text() + " > " + $("#province option:selected").text());
                    }else{
                        $("#table_body").empty().append("<tr><td>N/A</td><td>N/A</td><td>N/A</td><td>N/A</td><td>N/A</td></tr>");
