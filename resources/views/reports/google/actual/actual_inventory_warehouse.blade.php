...
@section('content')
    ...
    <div class="col-md-12 col-sm-12 col-xs-12" style="height: 1200px;">
        ...
        <form action="{{route('rcep.google_sheet.actualInventoryWarehouse')}}" method="POST" data-parsley-validate="" id="actual_form">
            {{ csrf_field() }}
            <div class="x_panel">
                <div class="x_title">
                    <h2>
                    ...
                    <button role="button" id="submit_actual_btn" type="button" class="btn btn-danger pull-right" style="border-radius:20px;"><i class="fa fa-send"></i> SUBMIT ACTUAL</button>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                ...
                <div class="x_content">
                    <div class="form-horizontal form-label-left">
                        <div class="form-group">
                            ...
                            <div class="col-md-10 col-sm-10 col-xs-10" required>
                                <input type="text" name="from_seed_coop" id="from_seed_coop" class="form-control" value="{{$shedule_coop_name}}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10 col-sm-10 col-xs-10" >
                                <input type="number" class="form-control" id="from_bags_for_delivery" name="from_bags_for_delivery" min="1" max="9999" value="{{$schedule_bagsForDelivery}}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10 col-sm-10 col-xs-10" >
                                ...
                                <br><br>
                                <input type="hidden" name="seed_variety_str" id="seed_variety_str" class="form-control" value="">
