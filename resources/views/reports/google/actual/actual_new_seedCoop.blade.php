...
@section('content')
    ...
    <div class="col-md-12 col-sm-12 col-xs-12" style="height: 1200px;">
        ...
        <form action="{{route('rcep.google_sheet.actualNewDS2021')}}" method="POST" data-parsley-validate="" id="actual_form">
            {{ csrf_field() }}
            <div class="x_panel">
                <div class="x_title">
                    <h2>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10 col-sm-10 col-xs-10" required>
                                <select name="source" id="source" class="form-control" required disabled>
                                    <option value="SEED_COOP" selected>Seed Cooperative / Association</option>
                                </select>
                            </div>
                        </div>
