...
@section('content')
    ...
    <div class="col-md-12 col-sm-12 col-xs-12" style="height: 1200px;">
        ...
        <form action="{{route('rcep.google_sheet.actualInventoryLgu')}}" method="POST" data-parsley-validate="" id="actual_form">
            {{ csrf_field() }}
            <div class="x_panel">
                <div class="x_title">
                    <h2>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10 col-sm-10 col-xs-10" required>
                                <select name="source" id="source" class="form-control" required disabled>
                                    <option value="LGU_STOCKS" selected>Stocks in LGU</option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="x_content">
                    <div class="form-horizontal form-label-left">
                        <div class="form-group">
                            ...
                            <div class="col-md-10 col-sm-10 col-xs-10" >
                                <input type="number" class="form-control" id="from_bags_in_lgu" name="from_bags_in_lgu" min="1" max="9999" value="{{$schedule_bagsInLgu}}" readonly>
                            </div>
                        </div>
            ...
            if(seed_variety != "0" && seed_total != "0"){
                ...
                $.ajax({
                    ...
                    success: function(data){
                        var current_total = $("#from_bags_in_lgu").val();
                        ...
                        if(add_to_total >= 0){
                            ...
                            $("#from_bags_in_lgu").val(add_to_total);
                        }else{
        ...
        function removeTagFromList(variety_id, seed_total){
            $.ajax({
                ...
                success: function(data){
                    ...
                    $("#from_bags_in_lgu").val(new_total);
                },
            });
        };
