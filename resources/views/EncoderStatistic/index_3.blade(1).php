...
$("#stocks_tbl").DataTable();
        ...
        $("#filter_btn_statistic").on('click', function () {            
            ...
            if(connection_Status == "connected"){
               loadData(station,Encoder,season);
			   search(myChart, station,Encoder,season);
            }else{
    ...
    $.ajaxSetup({
		...
		function search(chart,station,Encoder,season) {
	...
	function loadData(station,Encoder,season){
