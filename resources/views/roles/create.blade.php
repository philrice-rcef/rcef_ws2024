...
@section('content')
	...
	<div class="row">
	    <div class="col-lg-4">
	        <div class="pull-left">
	            <h2 class="mb-4" style="font-family: Fjalla_One; font-size: 3vw;">Create New Role</h2>
	        </div>
	    </div>
	</div>
                                ...
                                <div class="col-md-7">
                                    <div style="height: 400px; overflow-y: scroll; padding: 10px;">
            							@foreach($permissions as $value)
            								<label style="font-family: Noto; font-size: 1vw;">{!! Form::checkbox('permission[]', $value->permissionId, false, array('class' => 'name checkbox')) !!}
