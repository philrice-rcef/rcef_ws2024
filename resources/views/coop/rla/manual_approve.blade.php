        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" value="" id="request_id_reject" name="request_id_reject">
                    <table class="table table-striped table-bordered">
                        <thead>
                            <th style="width:20%;">Description</th>
                            <th style="width:80%;">Correspongin Value</th>
    ...
    <script>
        ...
        $("#approve_btn").on("click", function(e){
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(data["msg"] == "exceed_volume"){
                        alert("ERROR: The system detected that the specified laboratory number is already recorded: (current count: "+data["count"]+"), your input exceeds the maximum allocation of 240 bags.");
                    }else if(data["msg"] == "approve_ok"){
                        alert("SUCCESS: Action completed, the selected RLA is now approved and has been added to our database.");
                    }
        ...
        $("#reject_btn").on("click", function(e){
            ...
            $.ajax({
                ...
                success: function (data) {
                    if(data["msg"] == "reject_ok"){
                        alert("SUCCESS: Action completed, this RLA request will not be added to our database.");
                    }
