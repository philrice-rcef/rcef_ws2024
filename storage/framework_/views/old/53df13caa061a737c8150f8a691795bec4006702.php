        ...
        <div class="x_content form-horizontal form-label-left">
            ...
            <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-9">
                                      <b> From: </b> <input type="text" name="date1" id="date1" class="form-control" value="<?php echo e(date('m/01/Y')); ?>" />
                                      <b> To: </b> <input type="text" name="date2" id="date2" class="form-control" value="<?php echo e(date('m/d/Y')); ?>" />
                                </div>
                            </div>
...
//alert(document.getElementById("num_to").value);
    ...
    //alert(provCode);
            $.ajax({
                method: 'POST',
                url: "<?php echo e(route('FarGeneration.ebinhi.get_municipalities')); ?>",
                data: {
                    _token: _token,
                    province: provCode
                },
...
$('select[name="municipality_fg"]').on('change', function () {
    ...
    if(municipality === "0"){
        ...
        document.getElementById("download_flsar_ext_e").disabled = false;
           ...
           $.ajax({
                method: 'POST',
                url: "<?php echo e(route('FarGeneration.ebinhi.get_brgy')); ?>",
                data: {
                    _token: _token,
                    province: provCode,
...
$('select[name="brgy_fg"]').on('change', function () {
    ...
    if(municipality === "0"){
        ...
        document.getElementById("download_flsar_ext_e").disabled = false;
           ...
           $.ajax({
                method: 'POST',
                url: "<?php echo e(route('FarGeneration.ebinhi.get_dop')); ?>",
                data: {
                    _token: _token,
                    province: provCode,
                    municipality: municipality,
