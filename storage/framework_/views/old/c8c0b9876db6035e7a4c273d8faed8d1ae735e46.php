                    ...
                    <div class="row">
                        <div class="col-md-10" style="padding: 0">
                            <select name="province" id="province" class="form-control">
                                ...
                                <?php foreach($provinces as $p_row): ?>
                                    <option value="<?php echo e($p_row->province); ?>"><?php echo e($p_row->province); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                            ...
                            <div class="card-header" id="headingOne">
                                <h5 class="mb-0" style="margin:0">
                                    <button style="color: #7387a8;text-decoration:none;" class="btn btn-link">
                                        <?php echo e($row->province); ?> < <?php echo e($mun); ?>

                                    </button>
                                    <a href="#" data-toggle="modal" data-target="#municipal_distribution_modal" data-province="<?php echo e($prv); ?>" data-municipality="<?php echo e($mun); ?>" class="btn btn-warning btn-xs pull-right" style="margin-top: 9px;margin-right: 10px;"><i class="fa fa-eye"></i> View Beneficiaries</a>
                                    <a href="<?php echo e(route('paymaya.report.municipal', ['province' => $prv, 'municipality' => $mun])); ?>" target="_blank" data-toggle="modal" class="btn btn-success btn-xs pull-right" style="margin-top: 9px;margin-right: 10px;"><i class="fa fa-table"></i> Export to Excel</a>
                                </h5>
                            </div>
                        </div>
                    <?php endforeach; ?>
...
<script>
    ...
    $("#filter_btn").on("click", function(e){
        ...
        if(province != "0"){
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('paymaya.seed_distribution.municipal_list')); ?>",
                data: {
                ...
                success: function(data){
                    ...
                    jQuery.each(data, function(index, array_value){
                        ...
                        var url = "<?php echo e(route('paymaya.report.municipal', ['province' => ':province', 'municipality' => ':municipality'])); ?>";
    ...
    $("#municipal_distribution_modal").on("show.bs.modal", function(e){
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(route('paymaya.seed_distribution.municipal_totals')); ?>",
            data: {
                _token: "<?php echo e(csrf_token()); ?>",
                province: province,
            ...
            $("#municipal_tbl").DataTable({
                ...
                "order": [],
                "ajax": {
                    "url": "<?php echo e(route('paymaya.seed_distribution.tbl_municipal')); ?>",
                    "dataType": "json",
                    "type": "POST",
                    "data":{
                        "_token": "<?php echo e(csrf_token()); ?>",
