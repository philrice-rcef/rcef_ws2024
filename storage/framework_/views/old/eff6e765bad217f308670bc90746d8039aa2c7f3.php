                    ...
                    <form>
                        ...
                        <div class="heads">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="birthdate" aria-describedby="birthdate" value="<?php echo e(date('Y-m-d')); ?>">
                            </div>
                        </div>
                        <div class="heads">
...
<script>
    ...
    function getInitialProvinces(){
        $.ajax({
            type: 'GET',
            url: "<?php echo e(route('onlineEncodingNew.getProvinces')); ?>",
    ...
    $("#province_select").on('change', () => {
        $.ajax({
            type: 'GET',
            url: "<?php echo e(route('onlineEncodingNew.getMunicipalities')); ?>",
    ...
    $("#municipality_select").on('change', () => {
        $.ajax({
            type: 'GET',
            url: "<?php echo e(route('onlineEncodingNew.getDropoff')); ?>",
    ...
    $("#dropoff_select").on('change', () => {
        $.ajax({
            type: 'GET',
            url: "<?php echo e(route('onlineEncodingNew.getBalance')); ?>",
    ...
    function checkCurrentDatabase(){
        $.ajax({
            type: 'GET',
            url: "<?php echo e(route('onlineEncodingNew.verifyFarmerFromList')); ?>",
            data: {
    ...
    function getAddrProvinces(){
        $.ajax({
            type: 'GET',
            url: "<?php echo e(route('onlineEncodingNew.getAddrProvinces')); ?>",
            success: function(result){
                result.forEach((element, idx) => {
                    $("#address_bgy").empty();
                    $("#address_prv").append(`
    ...
    $("#address_prv").on('change', () => {
        $.ajax({
            type: 'GET',
            url: "<?php echo e(route('onlineEncodingNew.getAddrMunicipalities')); ?>",
    ...
    $("#address_mun").on('change', () => {
        $.ajax({
            type: 'GET',
            url: "<?php echo e(route('onlineEncodingNew.getAddrBarangays')); ?>",
    ...
    function finalizeProfile(){
        ...
        $("#variety_planted").select2({
            ...
            allowClear: true,
            ajax: {
                url: "<?php echo e(route('onlineEncodingNew.getSeedVars')); ?>",
                processResults: function (data) {
                    // Transform the data into the format expected by Select2
                    return {
                        results: $.map(data, function (item) {
    ...
    function saveDistribution(){
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(route('onlineEncodingNew.saveDistribution')); ?>",
            data: {
