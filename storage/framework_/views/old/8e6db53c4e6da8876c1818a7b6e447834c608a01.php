                    ...
                    <div id="overallStats">
                        <div>
                            ...
                            style="background-color: white">            
                                ...
                                <tbody>
                                <?php foreach($overallData as $data): ?>
                                    <tr>
                                    <td><?php echo e($data["Full_Name"]); ?></td>
                                    <td><?php echo e($data["Encoder"]); ?></td>
                                    <td style="background-color: 
                                        <?php echo e($data['Total_Encoded'] < $data['QuotaPrev'] ? '#ff0000aa' : 
                                        ...
                                        color: 
                                        <?php echo e($data['Total_Encoded'] < $data['QuotaPrev'] ? 'white' : 
                                            ($data['Total_Encoded'] >= $data['QuotaPrev'] && $data['Total_Encoded'] >= $data['Quota'] ? 'white' : 
                                                ($data['Total_Encoded'] >= $data['QuotaPrev'] ? 'inherit' : 'inherit')
                                            )); ?>">
                                        <?php echo e($data["Total_Encoded"]); ?>

                                    </td>

                                    <td><?php echo e($data["QuotaPrev"]); ?></td>
                                    <td><?php echo e($data["Quota"]); ?></td>
                                    <td><?php echo e($data["First_Contract"]); ?></td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
                            </table>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        window.onload = function () {
            ...
            order: [],
            ajax: {
                url: "<?php echo e(route('getOverallData')); ?>",
                dataType: "json",
                type: "POST",
                data: {
            ...
            order: [],
            ajax: {
                url: "<?php echo e(route('loadKpEncoderBreakdown')); ?>",
                dataType: "json",
                type: "POST",
                data: {
                _token: "<?php echo e(csrf_token()); ?>",
        ...
        $("#download_modal").on("shown.bs.modal", function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('getSeasons')); ?>",
                method: 'GET',
                dataType: 'json',
            ...
            $.ajax({
                url: "<?php echo e(route('getEncoders')); ?>",
                method: 'GET',
                dataType: 'json',
                success: function (data) {
                    if (data) {
