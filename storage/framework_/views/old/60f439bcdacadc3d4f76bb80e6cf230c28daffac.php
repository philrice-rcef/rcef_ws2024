                ...
                0 32px 64px rgba(0,0,0,0.07);">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="dash_div_data col-md-6">
                                  <?php echo e(number_format($dash_data->total_male)); ?> (<?php echo e($dash_data->percent_male); ?>%) 
                            </div>
                            ...
                            <div class="dash_div_data col-md-6">
                                    <?php echo e(number_format($dash_data->claimed_male)); ?>
                            ...
                            <div class="dash_div_data col-md-6">
                                    <?php /* uncomment me */ ?>
                                    <?php /* <?php echo e(number_format($dash_data->claimed_male / $dash_data->total_male, 2)); ?> */ ?>
                        ...
                        <div class="col-md-3" >
                            <div class="col-md-12" style="text-align: right; margin:5px;">
                                <img src="<?php echo e(asset('public/images/male_symbol.png')); ?>" style="width:130px; height:145px;">
                            </div>
        ...
        <div class='col-md-6' style=" left-margin:2px; ">
                ...
                0 32px 64px rgba(0,0,0,0.07);">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="dash_div_data col-md-6">
                                  <?php echo e(number_format($dash_data->total_female)); ?> (<?php echo e($dash_data->percent_female); ?>%) 
                            </div>
                            ...
                            <div class="dash_div_data col-md-6">
                                    <?php echo e(number_format($dash_data->claimed_female)); ?>
                            ...
                            <div class="dash_div_data col-md-6">
                                    <?php /* uncomment me */ ?>
                                    <?php /* <?php echo e(number_format($dash_data->claimed_female / $dash_data->total_female, 2)); ?> */ ?>
                            </div>
                        ...
                        <div class="col-md-3" >
                            <div class="col-md-12" style="text-align: right; margin:5px;">
                                <img src="<?php echo e(asset('public/images/female_symbol.png')); ?>" style="width:130px; height:145px;">
                            </div>
            ...
            <div id="map_nav" style="padding-left:10px;">
                            ...
                            <div class="col-md-12">
                                ...
                                <select name="map_region" id="map_region" class="form-control" style="width:20vw" onchange="map_region();male_female_percent();">
                                    ...
                                    <?php foreach($region as $reg): ?>
                                        <option value="<?php echo e($reg->regionName); ?>"> <?php echo e($reg->regionName); ?></option>
                                    <?php endforeach; ?>
                                </select>
                                </center>
                            </div>
                                ...
                                <div class="col-md-12" >
                                    <table  width="100%">
                                        <tr>
                                            ...
                                            <br> <font size='8' color='black'> <?php echo e(number_format($dash_data->percent_male)); ?>%</font>
                                            ...
                                            <br> <font size='8' color='black'> <?php echo e(number_format($dash_data->percent_female)); ?>%</font>
                                        </div></td>
                                        </tr>
                                    </table>
                    ...
                    <div class="row">
                        <div class="col-md-12" style="text-align:center;">
                            ...
                            <label id="est_area" style="font-size:42px; margin-top:0px;"><?php echo e(number_format($dash_data->claimed_female+$dash_data->claimed_male)); ?> (ha)</label>
                        </div>
                    </div>
                                    ...
                                    <td style="width: 50%" align="right">
                                        <div  style='border:solid; height:121px; width:132px; background-color:#00FF38; opacity:0.31; text-align:center; margin-right:5px;' >
                                            <label id="ala" style="font-size:38px;weight:bold; color:black;" for="">
                                             <?php /* uncomment me */ ?>
                                                <?php /* <?php echo e(number_format((($dash_data->claimed_male + $dash_data->claimed_female) / ($dash_data->total_male + $dash_data->total_female)),2 )); ?> */ ?>
                                            </label> <br>
                        ...
                        <table width="100%" style="margin-bottom:10px;">
                                ...
                                <td align="right">
                                    <div  style="height:60px;width:77px; background-color:#FFD600; border:solid;">
                                        <label id="cat1" style="font-size:28px;weight:bold;">
                                           <?php /* uncomment me */ ?>
                                            <?php /* <?php echo e(number_format(($dash_data->overall_cat1/($dash_data->total_male+$dash_data->total_female))*100)."%"); ?> */ ?>
                            ...
                            <tr>
                                <td align="right">
                                   ...
                                   <?php /* uncomment me */ ?>
                                        <?php /* <?php echo e(number_format(($dash_data->overall_cat2/($dash_data->total_male+$dash_data->total_female))*100)."%"); ?></label> */ ?>
                                    </div>
                                </td>
                                <td>
                                    <div  style="font-size:33px; margin-left:10px;">
                            ...
                            <tr>
                                <td align="right">
                                    ...
                                    <?php /* uncomment me */ ?>
                                        <?php /* <?php echo e(number_format(($dash_data->overall_cat3/($dash_data->total_male+$dash_data->total_female))*100)."%"); ?> */ ?>
                                </label>
                                    </div>
                                </td>
                                <td>
...
function generateMap(){
        ...
        if(province === "0"){
            if(region === "all"){
                ...
                $.ajax({
                        method: 'POST',
                        url: "<?php echo e(route('api.region.list')); ?>",
                        data: {
        ...
        $.ajax({
                ...
                success: function (source) {
                    $.each(source, function (i, d) {
                     ...
                     $.ajax({
                                method: 'POST',
                                url: "<?php echo e(route('api.region.coordinates')); ?>",
                                data: {
                                    _token: "<?php echo e(csrf_token()); ?>",
                                    region: region,
                                },
        ...
        $.ajax({
                ...
                success: function (source) {
                    $.each(source, function (i, d) {
                        ...
                        $.ajax({
                                method: 'POST',
                                url: "<?php echo e(route('api.province.coordinates')); ?>",
                                data: {
                                    _token: "<?php echo e(csrf_token()); ?>",
                                    province: province,
                                },
    ...
    function male_female_percent(){
       var region =  $("#map_region").val();
        ...
        if(region == "0"){
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('gad.gender.percent')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    type: "sex",
                    region: region,
 ...
 loadList();
    function ajax_variety_sex(){
        ...
        var female = [];
                $.ajax({
                        type: 'POST',
                        url: "<?php echo e(route('gad.generate.graph')); ?>",
                        data: {
                            _token: "<?php echo e(csrf_token()); ?>",
                            type: "variety_sex"
                        },
    ...
    HoldOn.open(holdon_options);
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('gad.dashboard.data')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    type: "bar_land"
                },
        ...
        $('#modal_gad_list').on('show.bs.modal', function (e) {
                    ...
                    "pageLength": 10,
                    "ajax": {
                        "url": "<?php echo e(route('gad.stored.excel')); ?>",
                        "dataType": "json",
                        "type": "POST",
                        "data":{
                            "_token": "<?php echo e(csrf_token()); ?>",   
...
//   $('#dataTBL').DataTable().clear();
                $('#dataTBL').DataTable({
                    ...
                    "pageLength": 25,
                    "ajax": {
                        "url": "<?php echo e(route('gad.monitoring.genTable')); ?>",
                        "dataType": "json",
                        "type": "POST",
                        "data":{
                            "_token": "<?php echo e(csrf_token()); ?>",   
