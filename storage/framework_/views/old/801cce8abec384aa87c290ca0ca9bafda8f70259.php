                                ...
                                <div class="_grid_item shadow-md _card mp">
                                    ...
                                    <div class="__grid">
                                        <div class="__grid_item _card shadow">
                                           <center><h1 class="bold" style="font-size: 6rem;"><?php echo e($total_fca); ?></h1></center>
                                            <center><h4 class="bold">FCA(s)</h4></center>
                                        </div>
                                        <div class="__grid_item">
                                            <h3><span class="bold" style="font-size: 3rem;"><?php echo e($total_fca_reg); ?></span> <span style="font-size: 2rem;">region(s)</span> </h3>
                                        </div>
                                        <div class="__grid_item">
                                            <h3><span class="bold" style="font-size: 3rem;"><?php echo e($total_fca_prv); ?></span> <span style="font-size: 2rem;">province(s)</span> </h3>
                                        </div>
                                        <div class="__grid_item">
                                            <h3><span class="bold" style="font-size: 3rem;"><?php echo e(number_format($total_fca_muni)); ?></span> <span style="font-size: 2rem;">municipalities</span> </h3>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row select_group">
                                            <div class="col">
                                                ...
                                                <select id="reg-select">
                                                    ...
                                                    <?php foreach($chartReg as $reg): ?>
                                                        <option value="<?php echo e($reg->regCode); ?>"><?php echo e($reg->regionName); ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                ...
                                <div class="_grid_item shadow-md _card mp">
                                    ...
                                    <div class="___grid">
                                        <div class="___grid_item _card shadow">
                                            <center><h1 class="bold omega_font"><?php echo e(number_format($total_fca_prereg_ave)); ?></h1></center>
                                            <?php if($total_fca <= 1): ?>
                                        ...
                                        <div class="___grid_item">
                                            <h3><span class="bold" style="font-size: 3rem;"><?php echo e($total_female_percent."%"); ?></span> <span style="font-size: 2rem">female</span></h3><h3><i class="fa fa-venus"></i></h3>
                                        </div>
                                        <div class="___grid_item">
                                            <h3><span class="bold" style="font-size: 3rem;"><?php echo e($total_male_percent."%"); ?></span> <span style="font-size: 2rem">male</span></h3><h3><i class="fa fa-mars"></i></h3>
                                        </div>
                                    </div>
                                    <span class="footnote fc">
                                        <i class="fc">
                                ...
                                <div class="_grid_item shadow-md _card mp">
                                    ...
                                    <div class="dist_bags">
                                        ...
                                        <span class="bold omega_font">
                                            <?php echo e(number_format($total_bags)); ?>
                        ...
                        <div class="grid_bottom">
                            <div class="grid_bottom_item _card shadow-md mp" style="position: relative;">
                                ...
                                <div class="avgyield_content" style="position: relative; display: flex; justify-content: center; align-items: center; flex-direction: column;">
                                    ...
                                    <span class="footnote" style="font-size: 1.2rem; font-style: italic; color: #888;">Data last synchronized as of <span class="bold lastSync"><?php echo e($lastSyncDate); ?></span></span>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    setTimeout(() => {
                        $.ajax({
                        type: 'GET',
                        url: "<?php echo e(route('unlinking')); ?>", 
                        data: {
                            _token: "<?php echo e(csrf_token()); ?>",
                            uri: data
                        },
        ...
        $('#reg-select').change(function(){
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('selRegChart')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
        ...
        $('#prv-select').change(function(){
            ...
            if($selected_prv == "All"){
                ...
                $.ajax({
                type: 'POST',
                url: "<?php echo e(route('selProvChart')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
        ...
        function load_ce_data(){
            $.ajax({
                type: 'GET',
                url: "<?php echo e(route('getCropEstab')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                },
                success: function(data){
        ...
        function load_eco_data(){
            $.ajax({
                type: 'GET',
                url: "<?php echo e(route('getEcoSys')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                },
                success: function(data){
        ...
        function load_avgyield_data(){
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(route('getAgeRangeView')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                },
                success: function(data){
