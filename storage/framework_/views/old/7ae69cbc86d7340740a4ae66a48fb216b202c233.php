...
<div class="container-fluid">
    ...
    <div class="card1 shadow-md round-sm mp">
        <div class="title">
            ...
            <?php /* <i class="fa fa-check" aria-hidden="true" style="color: green; font-size: 2rem;"></i> */ ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        function loadPrvUnsched(){
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(route('getPrvUnsched')); ?>",
                dataType: 'json',
                success: function(source){
                    // console.log(source);
        ...
        function loadPrvSched(){
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(route('getScheduledProvinces')); ?>",
                dataType: 'json',
                success: function(source){
