            ...
            <div class="x_content form-horizontal form-label-left">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <label id="from">
                        <input type="text" style="width: 80%; text-align: center;" value="<?php echo e(date('m/d/Y')); ?>" class="form-control" name="date1" id="date1" placeholder="Date From">
                        </label> <br>
                        
                        <label for="" class="col-xs-1">TO:</label>
                        <label id="to">
                        <input type="text" style="width: 80%; text-align: center;" value="<?php echo e(date('m/d/Y')); ?>" class="form-control" name="date2" id="date2" placeholder="Date To">
                        </label> 
                ...
                <div class="x_content" id="container_div" style="display: none">
                        ...
                        <div id="dl1" style="display: block">
                            ...
                            <?php /* <a href="" target="_blank" data-toggle='modal' class="btn btn-success btn-sm" ><i class="fa fa-download"></i> Download Payment Report</a> */ ?>
                            <button class="btn btn-success btn-sm" id="btn_report_dl"><i class="fa fa-download"></i> Download Payment Report</button>
                        </div>
                        <?php if(Auth::user()->username == "r.benedicto_2" ||  Auth::user()->username == "dc.gaspar" ||  Auth::user()->username == "jt.rivera" ||  Auth::user()->username == "reggie_dioses" ||  Auth::user()->username == "renaida_pascual" || Auth::user()->username == "processor_jbl" || Auth::user()->username == "ar.aromin"): ?>
                        <?php endif; ?>
                </div>
            </div>
        </div><br>
    ...
    <div class="modal-dialog" style="width: 30%;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <label id="from">
                    <input type="text" style="width: 50%; text-align: center;" value="<?php echo e(date('m/d/Y')); ?>" class="form-control" name="date3" id="date3" placeholder="Date From">
                </label> 
                <br><br><br>
    ...
    <script>
        ...
        function load_data(){
            ...
            $("#payment_tbl").DataTable({
                ...
                "order": [],
                "ajax": {
                    "url": "<?php echo e(route('paymaya.reports.payments.coop')); ?>",
                    "dataType": "json",
                    "type": "POST",
                    "data":{
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('paymaya.reports.payments.coop_dl')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    date1: $("#date1").val(),
                    date2:  $("#date2").val()
