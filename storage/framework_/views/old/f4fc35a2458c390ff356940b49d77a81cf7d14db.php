...
<div>
    <div class="row">
         <div class="col-md-12">
                <?php if($distributed != "N/A"): ?>
               <?php else: ?>
               <?php endif; ?>


        </div>
        <div id="id-auth" style="display: none"><?php echo e(Auth::user()->roles->first()->name); ?></div>
                    ...
                    <div class="x_content form-horizontal form-label-left">
                        <div class="row tile_count" style="margin: 0">
                            <div class="col-md-12 col-sm-12 col-xs-12 tile_stats_count" style="padding-bottom: 0;padding-left: 0;">
                                <div class="count" style="font-size:30px;"><?php echo e(number_format($confirmed->commitment)); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="flex" style="">
                    ...
                    <div class="x_content form-horizontal form-label-left">
                        <div class="row tile_count" style="margin: 0">
                            <div class="col-md-7 col-sm-12 col-xs-12 tile_stats_count" style="padding-bottom: 0;padding-left: 0;">
                                <div class="count" ><i class="fa fa-check-square-o" style="margin-right:3px;" aria-hidden="true"></i><?php echo e(number_format($confirmed->total_bag_count)); ?></div>
                            </div>

                            <div class="col-md-5 col-sm-12 col-xs-12" style="padding-bottom: 0;padding-left: 0;">
                                <div class="row ml-3">
                                    <div class="col-md-12 col-sm-4 col-xs-4">
                                        <div class="sub-count" id=""> <i class="fa fa-leaf"> RCEF: <?php echo e(number_format($confirmed->total_bag_count_RCEF)); ?></i>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-sm-4 col-xs-4">
                                        <div class="sub-count" id=""> <i class="fa fa-pagelines">   NRP (Inbred): <?php echo e(number_format($confirmed->total_bag_count_NRP)); ?></i>
                                        </div>
                                    </div>
            ...
            <div class="item">
                <div class="x_panel">
                    ...
                    <div class="x_content form-horizontal form-label-left">
                        <div class="row tile_count" style="margin: 0;">
                            <div class="col-md-7 col-sm-12 col-xs-12 tile_stats_count" style="padding-bottom: 0;padding-left: 0; ">
                                <div class="count"><i class="fa fa-truck"></i> <?php echo e(number_format($actual->total_bag_count +  $transferred_2 )); ?>
                            ...
                            <div class="col-md-5 col-sm-12 col-xs-12" style="padding-bottom: 0;padding-left: 0;">
                                <div class="row ml-3">
                                    <div class="col-md-12 col-sm-4 col-xs-4">
                                        <div class="sub-count" id=""> <i class="fa fa-eye"> Inspected: <?php echo e(number_format($actual->total_bag_count - $paymaya_delivery)); ?></i>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-sm-4 col-xs-4">
                                        <div class="sub-count" id=""> <i class="fa fa-refresh">   Transferred (PS): <?php echo e(number_format($transferred_2)); ?></i>
                                        </div>
                                    </div>

                                    <div class="col-md-12 col-sm-4 col-xs-4">
                                        <div class="sub-count" id="">
                                            <i class="fa fa-cube">   e-Binhi: <?php echo e(number_format($paymaya_delivery)); ?> </i> </div>
                                    </div>
                                    <div class="col-md-12 col-sm-4 col-xs-4">
                                        <div class="sub-count" id="">
                                            <i class="fa fa-mail-forward">   Buffer: <?php echo e(number_format($buffer)); ?> </i> </div>
                                    </div>
                                </div>
                            </div>
            ...
            <?php if($distributed != "N/A"): ?>
                <div class="item">
                    <div class="x_panel">
                        <div class="x_title">
                            <?php if(isset($distributed->date_generated)): ?>
                            <h2>Distributed (20kg/bags) - as of <i> <?php echo e(date( 'm/d/y', strtotime($distributed->date_generated))); ?>  </i></h2>
                        ...
                        <div class="x_content form-horizontal form-label-left">
                            <div class="row tile_count" style="margin: 0">
                                <div class="col-md-7 col-sm-12 col-xs-12 tile_stats_count" style="padding-bottom: 0;padding-left: 0;">
                                    <div class="count"><i class="fa fa-check-circle"></i> <?php echo e(number_format($distributed->total_bags + $paymaya_bags)); ?></div>
                                </div>

                                <div class="col-md-5 col-sm-12 col-xs-12" style="padding-bottom: 0;padding-left: 0;">
                                    <div class="row ml-3">
                                        <div class="col-md-12 col-sm-4 col-xs-4">
                                            <div class="sub-count" id=""> <i class="fa fa-cubes"> Regular: <?php echo e(number_format($distributed->total_bags)); ?></i>
                                            </div>
                                        </div>

                                        <div class="col-md-12 col-sm-4 col-xs-4">
                                            <div class="sub-count" id="">
                                            <i class="fa fa-cube">  e-Binhi: <?php echo e(number_format($paymaya_bags)); ?> </i> </div>
                                        </div>
			...
			<div class="item">
				<div class="x_panel">
					...
					<div class="x_content form-horizontal form-label-left">
						<div class="row tile_count" style="margin: 0">
							<div class="col-md-7 col-sm-12 col-xs-12 tile_stats_count" style="padding-bottom: 0;padding-left: 0;">
								<div class="count"><i class="fa fa-users"></i> <?php echo e(number_format($distributed->total_farmers + $paymaya_beneficiaries)); ?></div>
							</div>
                            ...
                            <div class="col-md-5 col-sm-12 col-xs-12" style="padding-bottom: 0;padding-left: 0;">
                                <div class="row ml-3">
                                    <div class="col-md-12 col-sm-4 col-xs-4">
                                        <div class="sub-count" id="">
                                         <i class="fa fa-cubes">    Regular: <?php echo e(number_format($distributed->total_farmers)); ?> </i> </div>
                                    </div>

                                    <div class="col-md-12 col-sm-4 col-xs-4">
                                        <div class="sub-count" id="">
                                          <i class="fa fa-cube">   e-Binhi: <?php echo e(number_format($paymaya_beneficiaries)); ?> </i></div>
                                    </div>
                    ...
                    <div class="x_content form-horizontal form-label-left">
                        <div class="row tile_count" style="margin: 0">
                            <div class="col-md-5 col-sm-12 col-xs-12 tile_stats_count" style="padding-bottom: 0;padding-left: 0;">
                                <div class="count"><i class="fa fa-male"></i> <?php echo e(number_format($malePercentage, 2)); ?>% </div>
                            </div>
                            
                            <div class="col-md-5 col-sm-12 col-xs-12 tile_stats_count" style="padding-bottom: 0;padding-left: 0;">
                                <div class="count"><i class="fa fa-female"></i> <?php echo e(number_format($femalePercentage, 2)); ?>% </div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="item">
				<div class="x_panel">
					...
					<div class="x_content form-horizontal form-label-left">
						<div class="row tile_count" style="margin: 0">
							<div class="col-md-12 col-sm-12 col-xs-12 tile_stats_count" style="padding-bottom: 0;padding-left: 0;">
								<div class="count"><i class="fa fa-map-marker"></i> <?php echo e(number_format($distributed->total_claimed_area,'2','.',',')); ?></div>
							</div>
						</div>
					</div>
				</div>
            ...
            <div class="item">
                <div class="x_panel">
                    ...
                    <div class="x_content form-horizontal form-label-left">
                        <div class="row tile_count" style="margin: 0">
                            <div class="col-md-7 col-sm-12 col-xs-12 tile_stats_count" style="padding-bottom: 0;padding-left: 0;">
                                <div class="count"><i class="fa fa-pagelines"></i> <?php echo e(number_format($total_yield,2)); ?></div>
                            </div>
                ...
                <div class="row tile_count" style="margin: 0">
                     <div class="col-md-12 col-sm-12 col-xs-12 tile_stats_count" style="padding-bottom: 0;padding-left: 0; text-align: center;">
                        <div class="count"><i class="fa fa-bar-chart"></i>
                            <!-- <?php echo e(number_format($yield_data->yield,2)); ?>

                             <?php /* <?php if($distributed->yield_ws2021 <= 0): ?> N/A <?php else: ?> <?php echo e($distributed->yield_ws2021); ?> <?php endif; ?> */ ?> -->
                             <?php echo e($percentage); ?>% out of <?php echo e($targetSum); ?>
			...
			<div class="col-md-4">
				<div class="x_panel">
					...
					<div class="x_content form-horizontal form-label-left">
						<div class="row tile_count" style="margin: 0">
							<div class="col-md-12 col-sm-12 col-xs-12 tile_stats_count" style="padding-bottom: 0;padding-left: 0;">
								<div class="count"><i class="fa fa-check-circle"></i> <font color="green"><?php echo e($load); ?> %</font> </div>
							</div>
						</div>
					</div>
				</div>
            ...
            <div class="x_panel" style="border-radius: 0.6em;">
                <div class="x_title">
                    ...
                    <div class="input-group pull-right" style="width: 500px;">
                        <input type="text" name="date_of_delivery" id="date_of_delivery" class="form-control" value="<?php echo e($filter_start); ?> - <?php echo e($filter_end); ?>" />
                ...
                <div class="x_content form-horizontal form-label-left" id="delivery_sched_div">
                    <?php if($delivery_regions != "no_deliveries"): ?>
                        <?php foreach($delivery_regions as $row): ?>
                            <div class="card">
                                <div class="card-header" id="headingOne">
                                    <h5 class="mb-0" style="margin:0">
                                        ...
                                        <a href="#" data-toggle="modal" data-target="#show_region_sched" data-region="<?php echo e($row->region); ?>" class="btn btn-warning btn-xs pull-right" style="margin-top: 9px;margin-right: 10px;"><i class="fa fa-eye"></i> View Deliveries</a>
                                    </h5>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <div class="no_delivery_wrapper" style="width:100%;height:400px;background-color:#d8d8d8;">
                            <img src="<?php echo e(asset('public/images/no_delivery.png')); ?>" alt="" style="display: block;margin: auto;height: 300px;padding-top: 25px;">
                    ...
                    <!--<div style="width:100%;height:500px;background-color:#d8d8d8;">
                        <img src="<?php echo e(asset('public/images/load_del.gif')); ?>" alt="" style="display: block;margin: auto;width: 100%;height:100%">
                    </div>-->
                </div>
            </div>
        </div>
...
<script>
    ...
    function refresh_national(){
       ...
       var data = "<?php echo e($_SERVER['REQUEST_URI']); ?>";
    ...
    $("#load_schedule_btn").on("click", function(e){
        ...
        delivery_div = delivery_div + '<img src="<?php echo e(asset('public/images/load_del.gif')); ?>" alt="" style="display: block;margin: auto;width: 100%;height:100%">';
        delivery_div = delivery_div + '</div>';
        $("#delivery_sched_div").append(delivery_div)

        $.ajax({
            type: 'POST',
            url: "<?php echo e(route('dashboard.delivery_schedule.search_regions')); ?>",
            data: {
            ...
            success: function(data){
                ...
                if(data == "no_deliveries"){
                    ...
                    delivery_div = delivery_div + '<img src="<?php echo e(asset('public/images/no_delivery.png')); ?>" alt="" style="display: block;margin: auto;height: 300px;padding-top: 25px;">';
    ...
    $('#show_region_sched').on('show.bs.modal', function (e) {
        ...
        if(id_auth === "rcef-programmer" || id_auth === "rcef-finance"){
            $("#delivery_sched_tbl").DataTable({
                ...
                "order": [],
                "ajax": {
                    "url": "<?php echo e(route('dashboard.delivery_schedule.custom')); ?>",
                    "dataType": "json",
                    "type": "POST",
                    "data":{
                        "_token": "<?php echo e(csrf_token()); ?>",
    ...
    //     $.ajax({
    //         type: 'POST',
    //         url: "<?php echo e(route('delivery_summary.provinces')); ?>",
    //         data: {
    //             _token: "<?php echo e(csrf_token()); ?>",
    //             region: region
    //         },
    ...
    //     $.ajax({
    //         type: 'POST',
    //         url: "<?php echo e(route('delivery_summary.municipalities')); ?>",
    //         data: {
    //             _token: "<?php echo e(csrf_token()); ?>",
    //             region: region,
    //             province: province
    ...
    //        $.ajax({
    //         type: 'POST',
    //         url: "<?php echo e(route('rcef.national_refresh')); ?>",
    //         data: {
    //             _token: "<?php echo e(csrf_token()); ?>",
    //         },
    //         success: function(data){
    ...
    //        window.location.replace("<?php echo e(route('dashboard.index')); ?>")
    ...
    //                 "order": [],
    //                 "ajax": {
    //                     "url": "<?php echo e(route('delivery_summary.datatable')); ?>",
    //                     "dataType": "json",
    //                     "type": "POST",
    //                     "data":{
    //                         "_token": "<?php echo e(csrf_token()); ?>",
    ...
    $("#province_select").on("change", function(e){
       ...
       $.ajax({
           type: 'POST', 
           url: "<?php echo e(route('delivery_summary.month')); ?>",
           data: {
               _token: "<?php echo e(csrf_token()); ?>",
               region: region,
               province: province,
   ...
   $("#refresh_national_data").on("click", function(e){
    ...
    var reg = $('#region').val();
    var url = '<?php echo e(route("exportData", ["reg" => ":reg"])); ?>';
    ...
    $("#show_iar_modal").on('show.bs.modal', function (e) {
        ...
        if(checkedVals.length>0){
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('delivery_summary.particulars')); ?>",
                dataType: "json",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
    ...
    $("#show_particulars_modal").on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('delivery_summary.viewParticulars')); ?>",
                dataType: "json",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    batch: batch,
