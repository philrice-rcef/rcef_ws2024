                        ...
                        <div class="card-header" id="headingOne">
                            <h5 class="mb-0" style="margin:0">
                                <button style="color: #7387a8;text-decoration:none;" class="btn btn-link">
                                    <?php echo e($row->coopName); ?>

                                </button>
                                <a href="#" data-toggle="modal" data-target="#show_coop_rla" data-coop="<?php echo e($row->accreditation_no); ?>" class="btn btn-warning btn-xs pull-right" style="margin-top: 9px;margin-right: 10px;"><i class="fa fa-eye"></i> VIEW RLA REQUESTS</a>
                            </h5>
                        </div>
                    </div>
                <?php endforeach; ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        $('#show_coop_rla').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('coop.rla.pmo_get_coop')); ?>",
                data: {
                ...
                $("#rla_tbl").DataTable({
                    ...
                    "order": [],
                    "ajax": {
                        "url": "<?php echo e(route('coop.rla.pmo_tbl')); ?>",
                        "dataType": "json",
                        "type": "POST",
                        "data":{
                            "_token": "<?php echo e(csrf_token()); ?>",
