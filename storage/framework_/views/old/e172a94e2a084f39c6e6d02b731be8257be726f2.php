    ...
    <div class="x_panel">
        ...
        <div class="x_content form-horizontal form-label-left">
            <div class="row">
                ...
                <div class="col-auto">
                    <form id="fileUpload" method="POST" action="<?php echo e(route('util.import_csv.rla')); ?>" enctype="multipart/form-data">
...
<script src="<?php echo e(asset('public/js/loadingoverlay.js')); ?>"></script>
<script>
   ...
   var sg_commitment = $("#sg_commitment").DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo e(route('import.table.rla')); ?>",
                "dataType": "json",
                "type": "POST",
                "data":{
