	...
	<div>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="x_panel">
					...
					<div class="x_content">
						<?php if(Auth::user()->roles->first()->name == "rcef-programmer" || Auth::user()->roles->first()->name == "branch-it"): ?>
							<?php if (\Entrust::can(('user-create'))) : ?>
							<a href="<?php echo e(route('users.create')); ?>" class="btn btn-success addBtn" style="margin-bottom: 20px;"><i class="fa fa-plus"></i> Add New User</a>
							<?php endif; // Entrust::can ?>

						<?php /* <a href="<?php echo e(route('users.create.request')); ?>" class="btn btn-success addBtn" style="margin-bottom: 20px;"><i class="fa fa-plus"></i> Request New User</a> */ ?>
						<?php endif; ?>

						<?php if(Auth::user()->roles->first()->name == "branch-it"): ?>

						<a href="<?php echo e(route('users.create.request')); ?>" class="btn btn-success addBtn" style="margin-bottom: 20px;"><i class="fa fa-plus"></i> Add New Branch User</a>
						<?php endif; ?>
		...
		<div id="reset_password_modal" class="modal fade" role="dialog">
			<div class="modal-dialog">
				<!-- Modal content-->
				<form action="<?php echo e(route('users.reset')); ?>" method="POST" data-parsley-validate>
				<?php echo csrf_field(); ?>
		...
		<div id="assignProvince" class="modal fade" role="dialog">
			<div class="modal-dialog">
				<!-- Modal content-->
				<form action="<?php echo e(route('users.update.province')); ?>" method="POST" data-parsley-validate>
				<?php echo csrf_field(); ?>
		...
		<div id="changeInfo" class="modal fade" role="dialog">
			<div class="modal-dialog">
				<!-- Modal content-->
				<form action="<?php echo e(route('users.update.info')); ?>" method="POST" data-parsley-validate>
					<?php echo csrf_field(); ?>
		...
		<div id="changeRole" class="modal fade" role="dialog">
			<div class="modal-dialog">
				<!-- Modal content-->
				<form action="<?php echo e(route('users.update.role')); ?>" method="POST" data-parsley-validate>
					<?php echo csrf_field(); ?>
		...
		<div id="assignModal" class="modal fade" role="dialog">
			<div class="modal-dialog">
				<!-- Modal content-->
				<form action="<?php echo e(route('users.assign.coopID')); ?>" method="POST" data-parsley-validate>
				<?php echo csrf_field(); ?>
		...
		<div id="update_accre_modal" class="modal fade" role="dialog">
			<div class="modal-dialog">
				<!-- Modal content-->
				<form action="<?php echo e(route('users.update.coopID')); ?>" method="POST" data-parsley-validate>
				<?php echo csrf_field(); ?>
...
<?php $__env->startPush('scripts'); ?>
	<script>
		...
		$('#assignProvince').on('show.bs.modal', function (e) {
			...
			$.ajax({
				type: 'POST',
				url: "<?php echo e(route('user.province.list')); ?>",
				data: {
				...
				success: function(data){
					...
					$.ajax({
							type: 'POST',
							url: "<?php echo e(route('user.municipality.list')); ?>",
							data: {
								_token: "<?php echo e(csrf_token()); ?>",
								userID: userID,
		...
		$('#assignModal').on('show.bs.modal', function (e) {
			...
			$.ajax({
				type: 'POST',
				url: "<?php echo e(route('coop.list')); ?>",
				data: {
					_token: "<?php echo e(csrf_token()); ?>",
					coop: 0
				},
