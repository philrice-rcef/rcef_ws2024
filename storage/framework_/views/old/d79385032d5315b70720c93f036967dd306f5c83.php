            ...
            <div class="x_title">
                ...
                <section class="group_selector">
                        ...
                        <?php foreach($seasons as $row): ?>
                                    <option value="<?php echo e($row['season_code']); ?>"><?php echo e($row['season'].' '.$row['season_year']); ?></option>
                                <?php endforeach; ?>
                        </select>
                        </div>
                        ...
                        <button type="button" id="reset" class="btn btn-secondary">Reset</button> 
                            ...
                            <div class="col-md-6">
                                ...
                                <hr>
                                <h1 id="countProv"><?php echo e($countProvinces); ?> Provinces</h1>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="boxes shadow-md" >
                                ...
                                <hr>
                                <h1 id="countMun"><?php echo e($countMunicipalities); ?> Municipalities</h1>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="boxes shadow-md" >
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script> 
        ...
        $('#season').change(() => {
            ...
            $.ajax({ 
                type: 'POST',
                url: "<?php echo e(route('get_KPRegions')); ?>",
                data: {
        ...
        $('#region').on('change', () => {
            ...
            $.ajax({ 
                type: 'POST',
                url: "<?php echo e(route('get_KPprovinces')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    reg: $reg,
                    ssn: $ssn
        ...
        $('#provinces').change(() => {
            ...
            $.ajax({ 
                type: 'POST',
                url: "<?php echo e(route('get_KPMunicipalities')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    prov: $prov,
                    ssn: $ssn
        ...
        $('#submit').on('click', () =>{
            ...
            $.ajax({ 
                type: 'POST',
                url: "<?php echo e(route('load_KPDistribution')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    reg: $reg,
                    prv: $prv,
        ...
        $('#sync').on('click', () =>{
            ...
            $.ajax({ 
                type: 'POST',
                url: "<?php echo e(route('get_KPDistribution')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    reg: $reg,
                    prv: $prv,
        ...
        $("#download_btn").on("click", function(e){
            ...
            var ssn = $('#season').val();
            var storedData = $proc;
            var url = '<?php echo e(route("export_KPDistribution", ["reg" => ":reg", "prv" => ":prv", "mun" => ":mun", "ssn" => ":ssn", "storedData" => ":storedData"])); ?>';
