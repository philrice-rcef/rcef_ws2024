...
<?php $__env->startSection('styles'); ?>
  ...
  <?php /* <link rel="stylesheet" href="<?php echo e(asset('public/css/xmas.css')); ?>"> */ ?>
  <?php /* <link rel="stylesheet" href="<?php echo e(asset('public/css/bootstrap.min.css')); ?>"> */ ?>
  <style>
    *{
...
<?php /* <div class="easteregg">
  <span><i id="jiggle-bell" class="fa fa-bell" aria-hidden="true"></i> Happy Holidays <?php echo e(Auth::user()->firstName); ?>!</span>
</div> */ ?>
<div class="___content" style="position: relative; padding-top: 10rem; margin-bottom: 10rem; height: max-content;">
  <?php /* <div class="trychartt shadow-md" style="width: 30rem; background: #808080;"> 
        ...
        <div class="actual_content">
          <div class="headings" style="display: grid; grid-template-columns: 3fr 3fr 3fr 2fr; gap: 2rem;">
            ...
            <!-- <div class="_card1 slideFromRight" style="opacity: 0; display: flex; gap: 1.2em; background: rgba(143, 201, 255, 0.286); border-radius: 20px; padding: 0.4rem 1.2rem 0.4rem 0.4rem; overflow: hidden;">
              ...
              <div class="labels" style="gap: 0;display: flex; align-items: start; justify-content: space-between; flex-direction: column; overflow: hidden;">
                ...
                <div style="font-size: 1.4rem; font-weight: 700;"><?php echo e($s_questions[0]['total_response']); ?> <span style="font-weight: 500; font-size: 1rem">Total Respondents</span></div>
                <div style="font-size: 1.4rem; font-weight: 700;"><span id="femalePercBep"><?php echo e($femalePerc); ?></span>% <span style="font-weight: 500; font-size: 1rem">Female</span></div>
                <div style="font-size: 1.4rem; font-weight: 700;"><span id="malePercBep"><?php echo e($malePerc); ?></span>% <span style="font-weight: 500; font-size: 1rem">Male</span></div>
              </div>
            </div>
            ...
            <div class="_card1 slideFromRight3" style="opacity: 0; display: flex; gap: 1.2em; background: rgba(112, 213, 137, 0.286); border-radius: 20px; padding: 0.4rem 1.2rem 0.4rem 0.4rem;">
              <div class="logo" style="aspect-ratio: 1; font-weight: 900; font-size: 3rem; display: flex; align-items: center; justify-content: center; background:rgba(0, 183, 89, 0.308); padding: 1em; border-radius: 20px;">
                <?php echo e(count($survey_questions)); ?>
          ...
          <div class="head_title_content" style="border-radius: 10px; position: relative; margin-bottom: 1em; display: flex; justify-content: space-between; padding: 1em; overflow: hidden;">
            ...
            <div style="display: flex; gap: 1rem;">
              ...
              <h2>with <span id="totalBep" style="font-weight: 700;"><?php echo e($s_questions[0]['total_response']); ?></span> respondents</h2>
            </div>
          ...
          <div class="cards_questions shadow-inner" style="height: 55vh; display: grid; grid-template-columns: 1fr 1fr ; gap: 1em; overflow-y: auto; overflow-x: hidden; border-radius: 10px; padding: 1em;">
            ...
            <!-- <?php foreach($perc_questions as $row): ?>
              <?php if($row['type'] == 'spec'): ?>
                <a href="#container">
                  <div class="indiv_qs _cardq shadow-none" style="background: rgba(130, 161, 187, 0.064); height: 20rem; border-radius: 10px; padding: 0; cursor: pointer;" data-data="<?php echo e($row['id']); ?>" data-qs="<?php echo e($row['qs']); ?>">
                    <div class="question_cont" style="margin: 1em; color: black;"><?php echo e($row['qs']); ?></div>
                    <hr>
                    <div class="percentages" style="padding: 1rem; display: flex; gap: 1em; align-items: center; justify-content: space-evenly;">
                      <div style="font-size: 2rem; font-weight: 700; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                        <div id="<?php echo e($row['id']); ?>_agree"><?php echo e($row['agree']); ?>%</div>
                      ...
                      <div style="font-size: 2rem; font-weight: 700; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                        <div id="<?php echo e($row['id']); ?>_neutral"><?php echo e($row['neutral']); ?>%</div>
                      ...
                      <div style="font-size: 2rem; font-weight: 700; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                        <div id="<?php echo e($row['id']); ?>_disagree"><?php echo e($row['disagree']); ?>%</div>
                      ...
                      <div style="font-size: 2rem; font-weight: 700; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                        <div id="<?php echo e($row['id']); ?>_none"><?php echo e($row['none']); ?>%</div>
              ...
              <?php else: ?>
                <a href="#container">
                  <div class="indiv_qs _cardq shadow-none" style="background: rgba(130, 161, 187, 0.064); height: 20rem; border-radius: 10px; padding: 0; cursor: pointer;" data-data="<?php echo e($row['id']); ?>" data-qs="<?php echo e($row['qs']); ?>">
                    ...
                    <div class="percentages" style="padding: 1rem; display: flex; gap: 1em; align-items: center; justify-content: space-evenly;">
                      <div style="font-size: 2rem; font-weight: 700; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                        <div id="<?php echo e($row['id']); ?>_yes"><?php echo e($row['yes']); ?>%</div>
                      ...
                      <div style="font-size: 2rem; font-weight: 700; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                        <div id="<?php echo e($row['id']); ?>_no"><?php echo e($row['no']); ?>%</div> 
                      ...
                      <div style="font-size: 2rem; font-weight: 700; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                        <div id="<?php echo e($row['id']); ?>_maybe"><?php echo e($row['maybe']); ?>%</div>
                        <span class="line-clamp-1" style="font-size: 1.2rem; background: rgba(182, 182, 182, 0.184); padding: 0.2em 0.4em; border-radius: 10px;">no answer</span>
                      </div>
                    </div>
                  </div>
            ...
            <?php foreach($s_questions as $key => $question): ?>
              <?php if($question['type'] == 'yesno'): ?>
                <!-- <a href="#container"> -->
                  <div class="indiv_qs _cardq shadow-none" style="background: rgba(130, 161, 187, 0.064); height: 20rem;  border-radius: 10px; padding: 0; cursor: pointer;" data-data="<?php echo e($question['id']); ?>" data-qs="<?php echo e($question['question']); ?>">
                    <div class="question_cont" style="margin: 1em; color: black;"><?php echo e($question['id']); ?>. <?php echo e($question['question']); ?></div>
                    <hr>
                    <div class="percentages" style="padding: 1rem; display: flex; gap: 1em; align-items: center; justify-content: space-evenly;">
                      <?php foreach($question['options'] as $loopIndex => $option): ?>
                        <?php 
                         ...
                         ?>
                        <!-- <div style="font-size: 2rem; font-weight: 700; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                            <div id="<?php echo e($row['id']); ?>_agree"></div>
                            <span class="<?php echo e($class); ?> line-clamp-1" style="font-size: 2rem; background: <?php echo e($backgroundColor); ?>; padding: 0.2em 0.4em; border-radius: 10px;"><?php echo e($option['display']); ?></span>
                            <div class="progress-bar" style="width: <?php echo e($percentage); ?>%; background: <?php echo e($backgroundColor); ?>; height: 2rem; border-radius: 10px; position: relative;margin:1em;left: 0;">
                              <span style="position: absolute; left: 50%; top: 150%; transform: translate(-50%, -50%); font-size: 1rem; font-weight: 700; color: #333;">
                                  <?php echo e($option['count']); ?>/<?php echo e($total_respoondents_conv); ?>

                              </span>
                            </div>
                        </div> -->
                        <div style="font-size: 2rem; font-weight: 700; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                              <div id="<?php echo e($question['id']); ?>_agree"></div>
                              <span class="<?php echo e($class); ?> line-clamp-1" style="font-size: 2rem; background: <?php echo e($backgroundColor); ?>; padding: 0.2em 0.4em; border-radius: 10px;"><?php echo e($option['display']); ?></span>
                              <div class="progress-bar-container" style="width: 100%; background: #f1f1f1; border-radius: 5px; margin-top: 0.5em; margin-left: 0.5em; position: relative; border: 2px solid <?php echo e($backgroundColor); ?>;">
                                <div id="bep_bar_<?php echo $key; ?>_<?php echo $loopIndex; ?>" class="progress-bar" style="width: <?php echo e($percentage); ?>%; background: <?php echo e($backgroundColor); ?>; height: 2rem; border-radius: 5px; position: relative; left: 0;"></div> 
                                ...
                                <?php echo e($option['count']); ?> / <?php echo e($question['total_response']); ?>

                                </span>
                              </div>
                              <!-- <div><?php echo e(number_format($percentage, 2)); ?>%</div> -->
                          </div>
                        <!-- <div style="font-size: 2rem; font-weight: 700; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                              <div id="<?php echo e($question['id']); ?>_agree"></div>
                              <span class="<?php echo e($class); ?> line-clamp-1" style="font-size: 2rem; background: <?php echo e($backgroundColor); ?>; padding: 0.2em 0.4em; border-radius: 10px;"><?php echo e($option['display']); ?></span>
                              <div class="progress-bar-container" style="width: 100%; background: #f1f1f1; border-radius: 10px; margin-top: 0.5em; position: relative;">
                                  <div class="progress-bar" style="width: <?php echo e($percentage); ?>%; background: <?php echo e($backgroundColor); ?>; height: 1rem; border-radius: 10px; position: relative;">
                  ...
                  <div class="indiv_qs _cardq shadow-none" style="background: rgba(130, 161, 187, 0.064); height: 20rem; border-radius: 10px; padding: 0; cursor: pointer;" data-data="<?php echo e($question['id']); ?>" data-qs="<?php echo e($question['question']); ?>">
                    ...
                    <div class="percentages" style="padding: 1rem; display: flex; gap: 1em; align-items: center; justify-content: space-evenly;">
                        <?php foreach($question['options'] as $loopIndex => $option): ?>
                          ...
                          <div style="font-size: 2rem; font-weight: 700; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                              <div id="<?php echo e($row['id']); ?>_agree"></div>
                              <span class="<?php echo e($class); ?> line-clamp-1" style="font-size: 1.2rem; background: <?php echo e($backgroundColor); ?>; padding: 0.2em 0.4em; border-radius: 10px;"><?php echo e($option['display']); ?></span>
                              <div class="progress-bar-container" style="width: 100%; background: #f1f1f1; border-radius: 5px; margin-top: 0.5em; margin-left: 0.5em; position: relative; border: 2px solid <?php echo e($backgroundColor); ?>;">
                                <div id="bep_bar_<?php echo $key; ?>_<?php echo $loopIndex; ?>" class="progress-bar" style="width: <?php echo e($percentage); ?>%; background: <?php echo e($backgroundColor); ?>; height: 2rem; border-radius: 5px; position: relative; left: 0;"></div> 
                                <span  id="bep_question_<?php echo $key; ?>_<?php echo $loopIndex; ?>" style="position: absolute; left: 50%; top: 50%; transform: translate(-50%, -50%); font-size: 1.2rem; font-weight: 700; color: (182, 182, 182, 0.184);">
                                <?php echo e($option['count']); ?> / <?php echo e($question['total_response']); ?>
        ...
        <div class="actual_content">
          <div class="headings" style="display: grid; grid-template-columns: 3fr 3fr 3fr 2fr; gap: 2rem;">
            ...
            <!-- <div class="_card1 slideFromRight2" style="opacity: 0; display: flex; gap: 1.2em; background: rgba(143, 201, 255, 0.286); border-radius: 20px; padding: 0.4rem 1.2rem 0.4rem 0.4rem;">
              ...
              <div class="labels" style="gap: 0;display: flex; align-items: start; justify-content: space-between; flex-direction: column; overflow: hidden;">
                <span style="font-size: 1.6rem; font-weight: 700;">Respondents</span>
                <div style="font-size: 1.4rem; font-weight: 700;"><?php echo e($total_respoondents_conv); ?> <span style="font-weight: 500; font-size: 1rem">Total Respondents</span></div>
                <div style="font-size: 1.4rem; font-weight: 700;"><?php echo e($femalePerc); ?>% <span style="font-weight: 500; font-size: 1rem">Female</span></div>
                <div style="font-size: 1.4rem; font-weight: 700;"><?php echo e($malePerc); ?>% <span style="font-weight: 500; font-size: 1rem">Male</span></div>
              </div>
            </div>
            ...
            <div class="_card1 slideFromRight4  " style="opacity: 0; display: flex; gap: 1.2em; background: rgba(112, 213, 137, 0.286); border-radius: 20px; padding: 0.4rem 1.2rem 0.4rem 0.4rem;">
              <div class="logo" style="aspect-ratio: 1; font-weight: 900; font-size: 3rem; display: flex; align-items: center; justify-content: center; background:rgba(0, 183, 89, 0.308); padding: 1em; border-radius: 20px;">
                <?php echo e(count($survey_questions_con)); ?>
          ...
          <div class="head_title_content" style="border-radius: 10px; position: relative; margin-bottom: 1em; display: flex; justify-content: space-between; padding: 1em; overflow: hidden;">
            ...
            <div style="display: flex; gap: 1rem;">
              ...
              <h2>with <span id="totalConv" style="font-weight: 700;"><?php echo e($questions_con[0]['total_response']); ?></span> respondents</h2>
            </div>
            ...
            <div class="div">
              ...
              <?php /* <button id="exportconraw" class="btn btn-primary" style="float: right;"><i style="font-weight: 300;" class="fa fa-file-excel-o" aria-hidden="true"></i> Export Raw Data</button> */ ?>
            </div>
            
          </div>
          <?php /* <div class="placeholder_empty" style="gap: 2em;position: absolute; left: 0; right: 0; bottom: 0; top: 0; display: flex; align-items: center; justify-content: center; flex-direction: column;">
          ...
          <!-- <div class="cards_questions shadow-inner" style="height: 55vh; display: grid; grid-template-columns: 1fr 1fr ; gap: 1em; overflow-y: auto; overflow-x: hidden; border-radius: 10px; padding: 1em;"> -->
            <!-- <?php foreach($perc_questions_conv as $row): ?>
              <?php if($row['type'] == 'spec'): ?>
                <a href="#containerConv">
                  <div class="indiv_qs shadow-none convClick" style="background: rgba(130, 161, 187, 0.064); height: 20rem; border-radius: 10px; padding: 0; cursor: pointer;" data-data="<?php echo e($row['id']); ?>" data-qs="<?php echo e($row['qs']); ?>">
                    <div class="question_cont" style="margin: 1em; color: black;"><?php echo e($row['qs']); ?></div>
                    <hr>
                    <div class="percentages" style="padding: 1rem; display: flex; gap: 1em; align-items: center; justify-content: space-evenly;">
                      <div style="font-size: 2rem; font-weight: 700; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                        <div id="<?php echo e($row['id']); ?>_yes_2"><?php echo e($row['yes_2']); ?>%</div>
                      ...
                      <div style="font-size: 2rem; font-weight: 700; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                        <div id="<?php echo e($row['id']); ?>_yes_1"><?php echo e($row['yes_1']); ?>%</div>
                      ...
                      <div style="font-size: 2rem; font-weight: 700; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                        <div id="<?php echo e($row['id']); ?>_no_1"><?php echo e($row['no_1']); ?>%</div>
                      ...
                      <div style="font-size: 2rem; font-weight: 700; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                        <div id="<?php echo e($row['id']); ?>_no_2"><?php echo e($row['no_2']); ?>%</div>
              ...
              <?php else: ?>
                <?php /* <a href="#container">
                  <div class="indiv_qs _cardq shadow-none convClick" style="background: rgba(130, 161, 187, 0.064); height: 20rem; border-radius: 10px; padding: 0; cursor: pointer;" data-data="<?php echo e($row['id']); ?>" data-qs="<?php echo e($row['qs']); ?>">
                    <div class="question_cont" style="margin: 1em; color: black"><?php echo e($row['qs']); ?></div>
                    <hr>
                    <div class="percentages" style="padding: 1rem; display: flex; gap: 1em; align-items: center; justify-content: space-evenly;">
                      <div style="font-size: 2rem; font-weight: 700; display: flex; flex-direction: column; align-items: center; justify-content: center;">
            ...
            <!-- <div class="cards_questions shadow-inner" style="height: 55vh; display: grid; grid-template-columns: 1fr  ; gap: 1em; overflow-y: auto; overflow-x: hidden; border-radius: 10px; padding: 1em;"> -->
              <?php foreach($questions_con as $key => $row): ?>
                <!-- <a href="#containerConv"> -->
                  <div class="indiv_qs shadow-none " style="background: rgba(130, 161, 187, 0.064); height: 20rem; border-radius: 10px; padding: 0; cursor: pointer;" data-data="<?php echo e($question['id']); ?>" data-qs="<?php echo e($question['question']); ?>">
                    <div class="question_cont" style="margin: 1em; color: black;"><?php echo e($row['id']); ?>. <?php echo e($row['question']); ?></div>
                    <hr>
                    <div class="percentages" style="padding: 1rem; display: flex; gap: 1em; align-items: center; justify-content: space-evenly;">
                    <?php foreach($row['options'] as $loopIndex => $option): ?>
                        <?php 
                          if ($loopIndex == 0) {
                              $backgroundColor = 'rgba(63, 255, 63, 0.184)';
                              $class = 'positive';
                        ...
                        <div style="font-size: 2rem; font-weight: 700; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                              ...
                              <span class="<?php echo e($class); ?> line-clamp-1" style="font-size: 1.2rem; background: <?php echo e($backgroundColor); ?>; padding: 0.2em 0.4em; border-radius: 10px;"><?php echo e($option['display']); ?></span>
                              <div class="progress-bar-container" style="width: 100%; background: #f1f1f1; border-radius: 5px; margin-top: 0.5em; margin-left: 0.5em; position: relative; border: 2px solid <?php echo e($backgroundColor); ?>;">
                                <div id="con_bar_<?php echo $key; ?>_<?php echo $loopIndex; ?>" class="progress-bar" style="width: <?php echo e($percentage); ?>%; background: <?php echo e($backgroundColor); ?>; height: 2rem; border-radius: 5px; position: relative; left: 0;"></div> 
                                ...
                                <?php echo e($option['count']); ?> / <?php echo e($row['total_response']); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
      ...
      $('._cardq').on('click', function() {
        ...
        $.ajax({
          type: 'POST',
          url: "<?php echo e(route('getIndivQuestion')); ?>",
          data: {
            _token: "<?php echo e(csrf_token()); ?>",
      ...
      $('.convClick').on('click', function() {
        ...
        $.ajax({
          type: 'POST',
          url: "<?php echo e(route('getIndivQuestionConv')); ?>",
          data: {
            _token: "<?php echo e(csrf_token()); ?>",
            question: $(this).data("data"),
            prv: $selected_prv,
      ...
      //   $.ajax({
      //     type: 'GET',
      //     url: "<?php echo e(route('getIncludedProvinces')); ?>",
      //     success: function(source){
      ...
      function loadMunicipalities(prv) {
          $.ajax({
              type: 'GET',
              url: "<?php echo e(url('/getIncludedMunicipality')); ?>/" + prv,
      ...
      function loadProvincesConv(){
        $.ajax({
          type: 'GET',
          url: "<?php echo e(route('getIncludedProvincesConv')); ?>",
          success: function(source){
            // console.log(source);
      ...
      //   $.ajax({
      //       type: 'POST',
      //       url: "<?php echo e(route('filterLocation')); ?>",
      //       data: {
      //         _token: "<?php echo e(csrf_token()); ?>",
      //         prv: $selected_prv,
      //         mun: $selected_mun,
      ...
      function filterResConv(){
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(route('filterLocationConv')); ?>",
            data: {
              _token: "<?php echo e(csrf_token()); ?>",
              prv: $selected_prv,
              mun: $selected_mun,
