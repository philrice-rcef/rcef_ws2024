                ...
                <div class="row">
                    <div class="col-md-10">
                        <select name="coop" id="coop" class="form-control">
                            ...
                            <?php foreach($cooperatives as $row): ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        $('#sg_tags_modal').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('load.sg.details')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                ...
                $("#sg_tags_tbl").DataTable({
                    ...
                    "order": [],
                    "ajax": {
                        "url": "<?php echo e(route('load.sg.tags')); ?>",
                        "dataType": "json",
                        "type": "POST",
                        "data":{
                            "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $("#add_to_blacklist_btn").on("click", function(e){
            ...
            if($("#blacklist_reason").val() == ''){
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('coop.member.blacklist')); ?>",
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>",
                        sg_id: sg_id,
