            ...
            <div class="col-md-4">
                    ...
                    <div class="card bg-c-green order-card">
                        <div class="card-block">
                            ...
                            <h1 class=""><i class="fa fa-users"></i><span>      <?php echo e($coop_edited); ?> SGC/A's</span></h1>
                            <p class="m-b-20"> <h5> Total Cooperatives:     <?php echo e($coop_count); ?> SGC/A's  </h5> </p>
            ...
            <div class="x_content">
                <div class="col-md-4">
                    ...
                    <select class="form-control form-select" name="coop_name" id="coop_name" >
                        ...
                        <?php foreach($coop_name as $coop_name): ?>
                            <option value="<?php echo e($coop_name->coopId); ?>" ><?php echo e($coop_name->coopName); ?></option>
...
<script>
            ...
            function genTable(){
                ...
                $("#logs").DataTable({
                    ...
                    "order": [],
                    "ajax": {
                        "url": "<?php echo e(route('adjustment_logs.gen_table')); ?>",
                        "dataType": "json",
                        "type": "POST",
                        "data":{
	  ...
	  $('select[name="coop_name"]').on('change', function () {
        ...
        $('select[name="logs_date"]').append('<option value=0>Select Available Dates</option>');
            ...
            $.ajax({
                method: 'POST',
                url: "<?php echo e(route('adjustment.logs.dates')); ?>",
                data: {
                    _token: _token,
                    coop_id: coop_name,
                },
