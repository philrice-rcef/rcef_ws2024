										...
										<div class="form-group">
                                            <select class="form-control" name="tagged_region" id="tagged_region">
												...
												<?php foreach($region_list as $region): ?>
													<option value="<?php echo e($region->regionName); ?>"><?php echo e($region->regionName); ?></option>
												<?php endforeach; ?>
											</select>
                                        </div>
                                        <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7" id="adjust_seed_variety">
                            <select class="form-control form-select" id="adjust_seed_variety_select">
                                <?php foreach($seed_variety as $variety): ?>
                                    <option value="<?php echo e($variety->variety); ?>"><?php echo e($variety->variety); ?></option>
                                <?php endforeach; ?>
                            </select>
    ...
    <script>
        ...
        function update_commitment(){
            ...
            if(yesno){
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('coop.commitment.new_update')); ?>",
                    data: {
                    ...
                    success: function(data){
                        ...
                        $("#coop_detail_tbl").DataTable({
                            ...
                            "order": [],
                            "ajax": {
                                "url": "<?php echo e(route('coop.details.table')); ?>",
                                "dataType": "json",
                                "type": "POST",
                                "data":{
                                    "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $("#coop_tbl").DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo e(route('coop.commitment.table')); ?>",
                "dataType": "json",
                "type": "POST",
                "data":{
                    "_token": "<?php echo e(csrf_token()); ?>"
        ...
        $("#update_moa_btn").on("click", function(e){
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('coop.commitment.moa')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    coop_id: coop_id,
        ...
        $("#deleteAllCommitment").on("click", function(e){
           ...
           $("#deleteAllCommitment").attr("disabled", "");
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('coop.commitment.cancel')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    coopID: coopID
                },
        ...
        $('#commitmentModal').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('coop.varities')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    coopID: coopID
                },
        ...
        function removeRecord(data) {      
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('coop.varities.delete')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    commitmentID: id
                },
                success: function(coop_id){
                    ...
                    $("#coop_add_tbl").DataTable({
                        ...
                        "order": [],
                        "ajax": {
                            "url": "<?php echo e(route('coop.save.table')); ?>",
                            "dataType": "json",
                            "type": "POST",
                            "data":{
                                "_token": "<?php echo e(csrf_token()); ?>",
        ...
        function removeRecordDetails(data) {    
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('coop.varities.delete.details')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    commitmentID: id
                },
                        ...
                        $.ajax({
                            ...
                            success: function(coop_id_data){
                               //get seed varities
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: "<?php echo e(route('coop.commitment.total')); ?>",
                                    data: {
                                        _token: "<?php echo e(csrf_token()); ?>",
        ...
        $("#Add_BTN").on("click", function(e){
            ...
            if(seed_variety == '0'){
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('coop.commitment.save')); ?>",
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>",
                        coopID: coopID,
                    ...
                    success: function(data){
                        ...
                        $.ajax({
                            type: 'POST',
                            url: "<?php echo e(route('coop.commitment.sub_total')); ?>",
                            data: {
                                _token: "<?php echo e(csrf_token()); ?>",
                                coopID: coopID
                            },
        ...
        $("#computeTotalCommitment").on("click", function(e){
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('coop.commitment.save.total')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    coopID: coopID,
        ...
        $('#coopDetails').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('coop.varities.details.add')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    coopDetailsID: coopDetailsID
                },
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('coop.adjustment.logs')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
        ...
        $("#add_submit_btn").on("click", function(e){
            ...
            if(seed_variety == "0"){
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('coop.add_more.submit')); ?>",
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>",
                        coopDetailsID: coopDetailsID,
                        seed_variety: seed_variety,
        ...
        $('#commitmentAdjustmentModal').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('coop.adjustment.regions')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    coop_id: coop_id
                },
		...
		function load_region_varities(){
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('coop.adjustment.varities')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    coop_id: coop_id,
                    region: region
		...
		function addallocation(regional_allocation_id){
			...
			if(available_balance > 0){
				...
				$.ajax({
					type: 'POST',
					url: "<?php echo e(route('coop.adjustment.add')); ?>",
					dataType: 'json',
					cache: false,
					data: {
						_token: "<?php echo e(csrf_token()); ?>",
        ...
        function deductAllocation(allocation_id){
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('coop.adjustment.deduct')); ?>",
                dataType: 'json',
                cache: false,
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
        ...
        $("#update_tf_btn").on("click", function(e){
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('coop.commitment.efficiency')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    coop_id: coop_id,
                    tar_eff: tar_eff
