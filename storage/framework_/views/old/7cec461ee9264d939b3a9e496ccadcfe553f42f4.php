    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="x_panel">
                ...
                <div class="x_content form-horizontal">
                    <img id="chart_gif" src="<?php echo e(asset('public/images/load_chart.gif')); ?>" alt="" id="loading_gif" style="display: block;margin: auto;height: 300px;padding-top: 25px;">
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        $.ajax({
            type: 'POST',
            url: "<?php echo e(route('analytics.top5')); ?>",
            data: {
        ...
        function load_summary_data(){
            ...
            $("#summary_variety_tbl").DataTable({
                ...
                "order": [],
                "ajax": {
                    "url": "<?php echo e(route('analytics.summary.per_variety')); ?>",
                    "dataType": "json",
                    "type": "POST",
                    "data":{
                        "_token": "<?php echo e(csrf_token()); ?>",
        ...
        function load_area_range_data(){
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('analytics.area_range')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                },
                success: function(data){
        ...
        function load_province_data(){
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('analytics.top_provinces')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                },
                success: function(data){
        ...
        function load_summary_chart(){
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('analytics.summary.per_variety_chart')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                },
                success: function(data){
