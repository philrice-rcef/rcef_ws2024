        ...
        <table class="header-info" cellspacing="0">
            <tr>
                ...
                <td class="header-data" style="width:400px">
                    <!-- coop name -->
                    <?php echo e($CoopName); ?><br/>

                <td class="header-titles" rowspan="2">IAR No.</td>
                <td class="header-data" style="width:70px" rowspan="2"><?php echo e($IAR_no); ?></td>
            </tr>
            
            <tr>
                <td class="header-titles" style="width:110px">Address</td>
                <td class="header-data" style="width:400px">
                    <?php echo e($coopAddress); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="header-data" style="width:70px"><?php echo e($Date); ?></td>
            </tr>
            <tr>
