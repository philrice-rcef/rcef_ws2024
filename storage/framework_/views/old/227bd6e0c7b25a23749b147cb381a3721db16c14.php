...
<table class="header-info" cellspacing="0" style="margin-top:3px;">
    ...
    <tr>
        ...
        <?php if($seedType ==='Regular'): ?>
            SEED RESERVE
        <?php elseif($seedType === 'NRP'): ?>
            SEED RESERVE
        <?php elseif($seedType === 'Good Quality Seeds'): ?>
            GQS SEED
        <?php else: ?>
        ...
        <td class="header-data" style="width:70px">&nbsp;</td>
        <td class="header-data" style="width:80px"><?php echo e($MOA); ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="header-data" colspan="6">
            ...
            <?php echo e($province); ?> , <?php echo e($municipality); ?> , <?php echo e($drop_off_point); ?>
            ...
            <div style="position:absolute; top:80px;width: 65%">
                <div style="width:90%;margin: 0 auto;">
                    ...
                    <div class="">
                       ...
                       <?php echo e($signatories[$province]); ?>

                       <?php /* Jhoemar B. Dela Cruz */ ?>
                    </div>
                </div>
            </div>
             <div style="position:absolute; top:120px;width: 65%">
                <div style="width:90%;margin: 0 auto;">
                    ...
                    <div class="">
                       <?php /* CES Regional Coordinator / FOMD, RCEF-PMO */ ?>
                       <?php echo e($position[$province]); ?>
    ...
    <tr>
        ...
        <td rowspan="8">
            ...
            <div style="position:fixed; left:59%; bottom:19.5%; vertical-align:middle;">
                ...
                <img class="qr_class" src="data:image/jpg;base64, <?php echo e(base64_encode(QrCode::format('png')->size(240)->margin(0)->generate($IAR_no))); ?>" style="height:170px;width:auto;"/>
                
          </div>
    
            <?php /* <div style="font-size:22px;  position:fixed; left:62%; bottom:14%; width:20%; text-align:center; font-weight:bold; vertical-align:bottom; padding-top:15px; padding-bottom:4px;">
               <u>SCAN ME</u>
            </div>
