        ...
        <div class="x_panel">
            ...
            <div class="x_content form-horizontal form-label-left">
                <table class="table table-hover table-striped table-bordered" id="province_tbl">
                    ...
                    <tbody>
                        <?php foreach($province_arr as $row): ?>
                            <tr>
                                <td><?php echo e($row["province"]); ?></td>
                                <td><?php echo e($row["total_bags"]); ?></td>
                                <td><?php echo e($row["total_beneficiaries"]); ?></td>
                                <td><?php echo e($row["total_area"]); ?></td>
                                <td><?php echo e($row["accepted_bags"]); ?></td>
                                <td><?php echo e($row["claim_total_bags"]); ?></td>
                                <td><?php echo e($row["claim_total_beneficiaries"]); ?></td>
                                <td><?php echo e($row["claim_total_area"]); ?></td>
                                <td>
                                    <a href="#" target="_blank" data-province="<?php echo e($row['province']); ?>" data-toggle='modal' data-target='#download_modal' class="btn btn-success btn-sm"><i class="fa fa-download"></i> Download</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
    ...
    <div class="modal-dialog" style="width: 30%;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <label id="from">
        <input type="text" style="width: 50%; text-align: center;" value="<?php echo e(date('m/01/Y')); ?>" class="form-control" name="date1" id="date1" placeholder="Date From">
                </label> <br>
                
                  <label for="" class="col-xs-3">TO:</label>
                <label id="to">
        <input type="text" style="width: 50%; text-align: center;" value="<?php echo e(date('m/d/Y')); ?>" class="form-control" name="date2" id="date2" placeholder="Date To">
                </label> 
    ...
    <script>
        ...
        $("#load_report_btn").on("click", function(e){
            ...
            $("#municipal_tbl").DataTable({
                ...
                "order": [],
                "ajax": {
                    "url": "<?php echo e(route('paymaya.beneficiary_report.province')); ?>",
                    "dataType": "json",
                    "type": "POST",
                    "data":{
