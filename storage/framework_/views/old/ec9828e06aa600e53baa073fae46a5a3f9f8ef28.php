...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <?php /* <hr style="border-top: 2px solid #d6d3d3;"> */ ?>
         <div class="row">
                ...
                <div class="col-md-3">
                    <select name="region" id="region" name="region" class="form-control">
                        ...
                        <?php foreach($regions as $row): ?>
                            <option value="<?php echo e($row->regionName); ?>"><?php echo e($row->regionName); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
    ...
    <script>
       ...
       function pieData(season,level,name){
        ...
        $("#region").on("change", function(e){
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('report.variety.provinces_data')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    region: region
                },
        ...
        $("#province").on("change", function(e){
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('report.variety.municipalities')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    region: region,
                    province: province
