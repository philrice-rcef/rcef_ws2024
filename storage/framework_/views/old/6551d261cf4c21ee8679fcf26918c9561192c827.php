...
<div class="x_panel">
            <div class="x_title">
                ...
                <select name="cooperatives_rla" id="cooperatives_rla" class="form-control">
                    ...
                    <?php foreach($coop_list as $coop_list): ?>
                        <option value="<?php echo e($coop_list->accreditation_no); ?>"><?php echo e($coop_list->coopName); ?></option>
                    <?php endforeach; ?>
                </select>
...
<script>
    ...
    function deleteRLA($id) {
        $.ajax({
            type: 'POST',
            url: "<?php echo e(route('coop.rla.confirmDeleteRLA')); ?>",
            data: {
    ...
    function graph(){
        ...
        $.ajax({
                type: 'POST',
                url: "<?php echo e(route('rla.monitoring.graph')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    accre: accre,
                   // area_id: area_id
        ...
        function loadList(){
           var accre = $("#cooperatives_rla").val();
                ...
                $('#dataTBL').DataTable({
                    ...
                    "pageLength": 10,
                    "ajax": {
                        "url": "<?php echo e(route('rla.monitoring.table')); ?>",
                        "dataType": "json",
                        "type": "POST",
                        "data":{
                            "_token": "<?php echo e(csrf_token()); ?>",   
