...
<html lang="en">
  <head>
    ...
    <?php echo $__env->make('layouts.cssLinks', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <body class="nav-md">
    <div class="container body">
        <div class="main_container">
          ...
          <?php echo $__env->make('layouts.sidebar_branch_it', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php elseif(Auth::user()->roles->first()->name == "nrp-admin" || Auth::user()->roles->first()->name == "nrp-lgu"): ?>
        <?php echo $__env->make('layouts.sidebar-nrp', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php else: ?>
      ...
      <div class="modal-dialog modal-lg">
          <div class="modal-content" style="width: 40%;">
              ...
              <div class="modal-body">
                ...
                <label id="from">
        <input type="text" style="width: 50%; text-align: center;" value="<?php echo e(date('m/01/Y')); ?>" class="form-control" name="stat_date1" id="stat_date1" placeholder="Date From">
                </label> <br>
                
                  <label for="" class="col-xs-3">TO:</label>
                <label id="to">
        <input type="text" style="width: 50%; text-align: center;" value="<?php echo e(date('m/d/Y')); ?>" class="form-control" name="stat_date2" id="stat_date2" placeholder="Date To">
                </label> 
              ...
              <div class="modal-body">
                <div class="form-horizontal form-label-left">  
                  ...
                  <audio id="qr_audio_paymaya">
                      <source src="<?php echo e(asset('public/sounds/Beep.mp3')); ?>" type="audio/mpeg">
                  </audio>
              </div>
              </div>
              <div class="modal-footer">
...
<!--DATA MODAL -->
    ...
    <?php echo $__env->make('layouts.jsLinks', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  </body>
</html>
