...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/daterangepicker/daterangepicker.css')); ?>" />
                ...
                <div class="form-group row">
                    <div class="col-sm-3">
                        ...
                        <select id="dop_select" name="dop_select" class="js-example-basic-single"
                            ...
                            <?php foreach($dops as $d): ?>
                            <option value="<?php echo e($d->ebinhi_dopID); ?>"><?php echo e($d->pickup_location); ?> ( <?php echo e($d->coop_name); ?> )</option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="col-sm-5">
                        ...
                        <select id="barangay_select" name="barangay_select[]" class="js-example-basic-multiple"
                            ...
                            ?>
                            <?php if($unsched > 0): ?>
                            <option value="<?php echo e($p->barangay_code); ?>"><?php echo e($p->name); ?> <b>(<?php echo e($unsched); ?>)</b></option>
                            <?php endif; ?>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class="col-sm-2">
                        ...
                        <select id="variety_select" name="variety_select[]" class="js-example-basic-multiple"
                            ...
                            <option value="<?php echo e($v[0]['seedVariety']); ?>"><?php echo e($v[0]['seedVariety']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="panel-group" id="accordion3" role="tablist" aria-multiselectable="true">
                ...
                <div class="panel panel-default" id="brgy_panels">
                    <div class="panel-heading" role="tab" id="head_<?php echo e($d->barangay_code); ?>">
                        <div class="panel-title container-fluid">
                            <div class="row">
                                <div class="col-md-5"><?php echo e($d->name); ?></b></div>
                                ...
                                <div class="col-md-1 text-right">
                                    <a role="button" class="collapseBtnBrgy" data-toggle="collapse"
                                        data-parent="#accordion3" href="#<?php echo e($d->barangay_code); ?>" aria-expanded="true"
                                        aria-controls="<?php echo e($d->barangay_code); ?>" data-brgy="<?php echo e($d->barangay_code); ?>">
                    ...
                    <div id="<?php echo e($d->barangay_code); ?>" class="panel-collapse collapse" role="tabpanel"
                        aria-labelledby="head_<?php echo e($d->barangay_code); ?>">
            ...
            <div class="container" style="padding: 30px">
                <div class="row" style="margin-bottom: 30px">
                    ...
                    <div class="col-sm-2">
                        ...
                        <input type="text" name="daterange" class="form-control" value="<?php echo e($datedefault); ?>" />
                    </div>
                    <div class="col-sm-2">
                                ...
                                <div class="row tile_count" style="margin: 0">
                                    <div class="col-md-12 col-sm-12 col-xs-12 tile_stats_count">
                                        <table class="table table-striped table-bordered wrap" style="width:100%"
                                            id="selectedFarmer<?php echo e($muni); ?>">
                                            <thead>
                                                <tr>
...
<script type="text/javascript" src="<?php echo e(asset('public/assets/daterangepicker/daterangepicker.js')); ?>"></script>
<script>
$('input[name="daterange"]').daterangepicker();
$('.js-example-basic-multiple').select2();
$('.js-example-basic-single').select2();
var selectedFarmer = $('#selectedFarmer<?php echo e($muni); ?>').DataTable({
    serverSide: true,
    processing: true,
    language: {
        'loadingRecords': '&nbsp;',
    ...
    ajax: {
        type: "POST",
        url: "<?php echo route('sra.paymaya.load.selected.farmers.datatable'); ?>",
        "data": function(d) {
            d._token = "<?php echo e(csrf_token()); ?>";
            d.brgy = $("#barangay_select").select2("val");
            d.variety = $("#variety_select").select2("val");
            d.month = "<?php echo e($month); ?>";
            d.muni = "<?php echo e($muni); ?>";
...
$(".collapseBtnBrgy").on("click", function() {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo e(url('sra/paymaya/load/farmers')); ?>",
        data: {
            brgy: brgy,
            month: "<?php echo e($month); ?>",
            muni: "<?php echo e($muni); ?>",
...
$("#schedFarmersSave").on("click", function (e) {
        ...
        if (answer) {
            $.ajax({
                type: "POST",
                url: "<?php echo e(url('sra/scheduling/save')); ?>",
                data: {
                    _token : "<?php echo e(csrf_token()); ?>",
    ...
    $('#selectedFarmer<?php echo e($muni); ?> tbody').on('click', 'tr td button.excludeFarmer', function (e) {
        e.preventDefault();
			var id = $(this).data('id');
			var status = $(this).data('status');
			$.ajax({
				type: "POST",
				url: "<?php echo e(url('ebinhi/scheduler/exclude')); ?>",
				data: {
                    id: id,
                    status: status,
					_token: "<?php echo e(csrf_token()); ?>"
