                            ...
                            <div class="card-header" id="headingOne">
                                <h5 class="mb-0" style="margin:0">
                                    <button style="color: #7387a8;text-decoration:none;" class="btn btn-link">
                                        <?php echo e($coop->coopName); ?>

                                    </button>
                                </h5>
                                <button class="btn btn-warning btn-sm" style="top: 10%;margin-right: 10px;position: absolute;right: 0%;" data-toggle="modal" data-target="#show_coop_batches_modal" data-coop="<?php echo e($coop->coopId); ?>" data-coop_accre="<?php echo e($coop->accreditation_no); ?>"><i class="fa fa-eye"></i> VIEW IAR</button>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
...
<script>
    ...
    $('#show_coop_batches_modal').on('show.bs.modal', function (e) {
        ...
        $("#coop_batch_table").DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo e(route('payment_dashboard.iar_tbl.home')); ?>",
                "dataType": "json",
                "type": "POST",
                "data":{
                    "_token": "<?php echo e(csrf_token()); ?>",
    ...
    $("#show_iar_modal").on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(route('payment_dashboard.particulars')); ?>",
            dataType: "json",
            data: {
                _token: "<?php echo e(csrf_token()); ?>",
