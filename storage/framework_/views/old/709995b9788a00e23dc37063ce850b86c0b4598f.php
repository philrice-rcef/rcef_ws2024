          ...
          <div class="grid-container">
            <div class="col-md-6" id="tgtben">
              <div class="boxes shadow-md">
                ...
                <h1 style="color: black">
                  <?php echo e($beneficiariesCount); ?> Beneficiaries
                </h1>
              </div>
            </div>
            <div class="col-md-6" id="tgtbag">
              <div class="boxes shadow-md">
                ...
                <hr />
                <h1 style="color: black"><?php echo e($bagsCount); ?> Bags</h1>
              </div>
            </div>
            <div class="col-md-6" id="tgtarea">
              <div class="boxes shadow-md">
                ...
                <hr />
                <h1 style="color: black"><?php echo e($areaCount); ?> ha</h1>
              </div>
            </div>
            <div class="col-md-6" id="actben">
              <div class="boxes shadow-md">
                ...
                <hr />
                <h1 style="color: black">
                  <?php echo e($actualBeneficiaries); ?> Beneficiaries
                </h1>
                <h6 style="color: black">
                  <span class="italicized"
                    >(<?php echo e($beneficiariesPercentage); ?>% accomplished, relative to
            ...
            <div class="col-md-6" id="actbag">
              <div class="boxes shadow-md">
                ...
                <hr />
                <h1 style="color: black"><?php echo e($actualBags); ?> Bags</h1>
                <h6 style="color: black">
                  <span class="italicized"
                    >(<?php echo e($bagsPercentage); ?>% accomplished, relative to target
                    bags)</span
                  >
                </h6>
              </div>
            ...
            <div class="col-md-6" id="actarea">
              <div class="boxes shadow-md">
                ...
                <hr />
                <h1 style="color: black"><?php echo e($actualArea); ?> ha</h1>
                <h6 style="color: black">
                  <span class="italicized"
                    >(<?php echo e($areaPercentage); ?>% accomplished, relative to target
                    area)</span
                  >
                </h6>
              </div>
          ...
          >
            ...
            >
              ...
              <tbody class="onLoadProvincialData">
                <?php foreach($provTgt as $row): ?>
                <tr>
                  <td><?php echo e($row["province"]); ?></td>
                  <td style="display: none"><?php echo e($row["municipality"]); ?></td>
                  <td><?php echo e($row["beneficiaries"]); ?></td>
                  <td><?php echo e($row["bags"]); ?></td>
                  <td><?php echo e($row["area"]); ?></td>
                  <td><?php echo e($row["actualBeneficiaries"]); ?></td>
                  <td><?php echo e($row["actualBags"]); ?></td>
                  <td><?php echo e($row["amount"]); ?></td>
                  <td><?php echo e($row["actualArea"]); ?></td>
                  <td>
                  <a href="<?php echo e(route('downloadPrvData', ['province' => $row['province']])); ?>" class="btn btn-success btn-sm">
                  <i class="fa fa-download"></i> Download provincial data</a>
                    <a
                      href="#"
                      target="_blank"
                      data-province="<?php echo e($row['province']); ?>"
                      data-toggle="modal"
...
<script>
  ...
  $("#submit").on("click", function (e) {
    ...
    $("#province_tbl2").DataTable({
      ...
      order: [],
      ajax: {
        url: "<?php echo e(route('get_DatedData')); ?>",
        dataType: "json",
        type: "POST",
        data: {
  ...
  $("#download_modal").on("shown.bs.modal", function (e) {
    ...
    $("#municipality_tbl").DataTable({
      ...
      order: [],
      ajax: {
        url: "<?php echo e(route('get_MunicipalData')); ?>",
        dataType: "json",
        type: "POST",
        data: {
          _token: "<?php echo e(csrf_token()); ?>",
  ...
  $("#download_modal2").on("shown.bs.modal", function (e) {
    ...
    $("#municipality_tbl2").DataTable({
      ...
      order: [],
      ajax: {
        url: "<?php echo e(route('get_DatedMunData')); ?>",
        dataType: "json",
        type: "POST",
        data: {
          _token: "<?php echo e(csrf_token()); ?>",
