<?php $__env->startSection('content'); ?>
            ...
            <div class="card" style="padding:5px;">
                ...
                <div class="row">
                    <div class="col-md-12 mt">
                        ...
                        <input type="text" class='form-control' id='birthdate' name='birthdate' value="<?php echo e(date("m/d/Y")); ?>" >
    ...
    <?php echo $__env->make("virtual_encoding.search_modal", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php echo $__env->make("virtual_encoding.modal_parcelary", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php echo $__env->make("virtual_encoding.select_dop_modal", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php echo $__env->make("virtual_encoding.scanner", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php echo $__env->make("virtual_encoding.add_parcel_modal", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php echo $__env->make("virtual_encoding.select_dop_modal_new", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    $("#new_farmer").on("click", function(){
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(route('virtual.municpality')); ?>",
            data: {
        ...
        $("#new_municipality").on("change", function(){
          ...
          var new_municipality =   $("#new_municipality").val();
            ...
            $.ajax({
            type: 'POST',
            url: "<?php echo e(route('virtual.brgy')); ?>",
            data: {
                _token: "<?php echo e(csrf_token()); ?>",
        ...
        $("#add_parcel_now").on("click", function(){
            ...
            $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('virtual.variety_balance')); ?>",
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>",
                        new_parcel_list: new_parcel_list,
                    },
        ...
        $('#select_dop_modal_new').on('show.bs.modal', function (e) {
             ...
             var birthdate =  "<?php echo e(date('Y-m-d')); ?>";
        ...
        // TRAPPER
            ...
            if(served == "false"){
                    ...
                    Swal.fire({
                        ...
                        $.ajax({
                            type: 'POST',
                            url: "<?php echo e(route('virtual.insert.distribution')); ?>",
                            data: {
                                _token: "<?php echo e(csrf_token()); ?>",
                                category: "INBRED",
                                float_id: float_id,
                ...
                var tbl_data = $('#distribution_tbl >tbody >tr').length;
                    ...
                    Swal.fire({
                        ...
                        $.ajax({
                            type: 'POST',
                            url: "<?php echo e(route('virtual.save.distribution')); ?>",
                            data: {
                                _token: "<?php echo e(csrf_token()); ?>",
                                category: "INBRED",
                                dop_selected_vs: dop_selected_vs,
    ...
    function clear_distri_form(){
                ...
                $("#birthdate").val("<?php echo e(date('m/d/Y')); ?>");
                $("#phone_number").val("");
    ...
    $("#irrigated").on("click", function(){
        ...
        function select_farmer(db_ref, prv){
            ...
            $.ajax({
            type: 'POST',
            url: "<?php echo e(route('virtual.select_farmer')); ?>",
            data: {
                _token: "<?php echo e(csrf_token()); ?>",
                prv: prv,
                db_ref: db_ref
        ...
        function get_parcel_list(db_ref, prv){
            ...
            $.ajax({
            type: 'POST',
            url: "<?php echo e(route('virtual.get.parcel')); ?>",
            data: {
                _token: "<?php echo e(csrf_token()); ?>",
                prv: prv,
                db_ref: db_ref
        ...
        function search(){
            ...
            var search_bar = $("#search_bar").val();
                ...
                $('#dataTBL').DataTable({
                    ...
                    "pageLength": 25,
                    "ajax": {
                        "url": "<?php echo e(route('virtual_search')); ?>",
                        "dataType": "json",
                        "type": "POST",
                        "data":{
                            "_token": "<?php echo e(csrf_token()); ?>",
        ...
        function show_parcelary(prv,db_ref,tbl){
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('vs.online.view.parcel')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    id: db_ref,
                    prv_number: prv,
    ...
    function get_parcelary(prv,db_ref,tbl){
        $('#parcelary_tbl').DataTable().clear();
            $('#parcelary_tbl').DataTable({
                ...
                "pageLength": 25,
                "ajax": {
                    "url": "<?php echo e(route('vs.get.all.parcel')); ?>",
                    "dataType": "json",
                    "type": "POST",
                    "data":{
                        "_token": "<?php echo e(csrf_token()); ?>",
