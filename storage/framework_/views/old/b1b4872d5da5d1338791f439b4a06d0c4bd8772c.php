<?php $__env->startSection('content'); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" name="distribution_province_new" id="distribution_province_new">
                                        <option></option>
                                        <?php foreach($provinces_list as $item): ?>
                                            <option value="<?php echo e($item->province); ?>"><?php echo e($item->province); ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
    ...
    <?php echo $__env->make('DeliveryDashboard.includes.iarlist', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        $("#distribution_province_new").on("change", function(e){
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('iar.municipalities')); ?>",
                data: {
        ...
        $("#distribution_municipality_new").on("change", function(e){
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('iar.dropoff')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    province: province,
