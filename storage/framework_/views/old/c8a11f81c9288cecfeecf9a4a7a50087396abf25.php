<?php /* <script src="<?php echo e(asset('public/js/jquery.min.js')); ?>"></script> */ ?>
<script src="<?php echo e(asset('public/js/app.js')); ?>"></script>
<script src="<?php echo e(asset('public/js/jquery.mask.js')); ?>"></script>
<script src="<?php echo e(asset('public/js/mask.test.js')); ?>"></script>
...
<script src=" <?php echo e(asset('public/js/dialog/jquery-confirm.min.js')); ?> "></script>
...
window.open(base_link+'/fargeneration/new/blank/pdf/'+size+'/'+pages, '_blank');
    ...
    $("#generate_municipal_statistics").on("click", function(e){
        ...
        var url = "<?php echo e(url('report/export/municipal/statistics')); ?>";
    ...
    $('#flsar_modal').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(route('pre_list.municipalities')); ?>",
            data: {
    ...
    $("#change_pass_btn").on("click", function(e){
        ...
        if(new_pass != "" && confirm_pass != ""){
            if(new_pass == confirm_pass){
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('users.change_password')); ?>",
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>",
                        new_pass: new_pass,
	...
	$('#paymaya_tags_modal').on('show.bs.modal', function (e) {
        $("#seedTag_paymaya").select2({
            ajax: {
                url: "<?php echo e(route('paymaya.list.seedTags.search')); ?>",
                dataType: 'json',
                type: "GET",
                quietMillis: 50,
    ...
    $("#flag_qr_btn").on("click", function(e){
        ...
        if(tag == "0" || qr_code == ""){
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('paymaya.seedTags.flag')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    tag: tag,
                    qr_code: qr_code
    ...
    $('#export_nrp').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(route('nrp.provinces')); ?>",
            data: {
                _token: "<?php echo e(csrf_token()); ?>",
            },
            success: function(data){
    ...
    $('#iar_print_log').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(route('pre_list.iar_list')); ?>",
            data: {
                _token: "<?php echo e(csrf_token()); ?>",
            },
            success: function(data){
   ...
   if(batchNumber !== "0"){
    ...
    $('#utilDel_modal').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(route('pre_list.batchNumber')); ?>",
            data: {
                _token: "<?php echo e(csrf_token()); ?>",
            },
            success: function(data){
    ...
    $("#search_button_rla").on("click", function(e){ 
        ...
        var rla_lot =  $("#find_lot").val();
                ...
                $('#rla_found').DataTable({
                    ...
                    "pageLength": 10,
                    "ajax": {
                        "url": "<?php echo e(route('rla.monitoring.find_rla')); ?>",
                        "dataType": "json",
                        "type": "POST",
                        "data":{
                            "_token": "<?php echo e(csrf_token()); ?>",   
