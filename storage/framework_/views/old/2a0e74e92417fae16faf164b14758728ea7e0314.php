                    ...
                    <?php foreach($regions as $region): ?>
                        <div class="card">
                            <div class="card-header" id="headingOne">
                                <h5 class="mb-0" style="margin:0" data-toggle="collapse" data-target="#collapse<?php echo e($region->id); ?>" onclick="getCoopsDetails(<?php echo e($region->id); ?>, 'list_<?php echo e($region->id); ?>')">
                                    <button style="color: #7387a8;text-decoration:none;" class="btn btn-link">
                                        <?php echo e($region->regDesc); ?>
...
<script>
  ...
  $('#show_coop_transfer_modal').on('show.bs.modal', function (e) {
        ...
        $("#coop_batch_table_transfer").DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo e(route('delivery_dashboard.batch.transfer.list')); ?>",
                "dataType": "json",
                "type": "POST",
                "data":{
    ...
    function getCoopsDetails(region_id, list_id){
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(route('delivery_dashboard.coop.region')); ?>",
            data: {
                _token: "<?php echo e(csrf_token()); ?>",
                region: region_id
            },
    ...
    function exportDeliveries_fmd(coop_accreditation, button_id){
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(route('delivery_dashboard.export_deliveries_fmd')); ?>",
            data: {
                _token: "<?php echo e(csrf_token()); ?>",
                coop_accreditation: coop_accreditation
            },
