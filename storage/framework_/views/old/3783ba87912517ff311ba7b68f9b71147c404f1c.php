...
<html lang="en" dir="ltr">
    ...
    <div class="ds-logo-right"><img 
        ...
        <table style="border:1px solid;"width="100%" cellspacing="0" >
            <tr>
                ...
                <td align="center" style="border:1px solid; width:40%; font-size:13px;"> <?php echo e($delivery[0]->municipality); ?>, <?php echo e($delivery[0]->province); ?></td>
    ...
    <tr>
        <td class="table-data tbldata" style="font-size:12px;" > <?php echo e($dv->seedTag); ?></td>
        <td class="table-data tbldata" style="font-size:12px; "><?php echo e($dv->seedVariety); ?></td>
